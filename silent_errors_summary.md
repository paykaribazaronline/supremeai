...
_Generated: 2026-09-07T16:07:00+00:00 · Scanner: `scripts/detect_silent_errors.py`_
...
- New findings (fail CI): **255**
- Known (baselined):      **602**
- Resolved since baseline: **271**
...
| medium | `scripts/advanced_analysis/circular_import_mapper.py:138` | `except-return-default` | `except (SyntaxError, ValueError, OSError): _ast_cache[key] = None return None` |
...
| low | `scripts/advanced_analysis/circular_import_mapper.py:71` | `except-no-log` | `except ValueError: # ব্যাকএন্ডের বাইরে হলে রিপো রুট থেকে রিলেটিভ নেবো try: rel =` |
| low | `scripts/advanced_analysis/circular_import_mapper.py:75` | `except-no-log` | `except ValueError: return filepath.stem` |
| low | `scripts/advanced_analysis/circular_import_mapper.py:679` | `except-no-log` | `except ValueError: lines.append(f"- `{mod}` → `{fp}`")` |
...
| low | `scripts/audit_observability.py:189` | `except-no-log` | `except Exception as e: safe_print(f"⚠️ Could not parse {py_file}: {e}")` |
