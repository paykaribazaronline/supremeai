...
public class SolutionMemory {
  ...
  /**
   * Calculates the "Supreme Score" to rank which solution is best. Weights: 50% Success Rate, 30%
   * Security Score, 10% Speed, 10% Simplicity.
   *
   * <p>Enhancement: Recency decay factor reduces confidence for older solutions unless marked as
   * timeless. Decay half-life: ~693 days (rate=0.001 per day).
   */
  ...
  public String getWorkingAIProvider() {
    return workingAIProvider;
  }

  public void setWorkingAIProvider(String workingAIProvider) {
    this.workingAIProvider = workingAIProvider;
  }
  ...
  public void setSourceAuthority(double sourceAuthority) {
  ...
  public SolutionMemory createUpdate(
      String newResolvedCode, long newExecutionTimeMs, double newSecurityScore) {
