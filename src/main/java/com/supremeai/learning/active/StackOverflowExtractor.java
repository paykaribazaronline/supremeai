...
/**
 * StackOverflow SiteExtractor - Scrapes hot programming questions from StackOverflow using the
 * StackExchange API.
 *
 * <p>Authority: 0.80 (high for code Q&A)
 */
@Component
      ...
      for (JsonNode question : items) {
        ...
        if (!title.isEmpty() && !link.isEmpty()) {
          ...
          ActiveInternetScraper.ScrapedIssue issue =
              new ActiveInternetScraper.ScrapedIssue(title, answer, "StackOverflow");
