...
/**
 * Persistence service for evolution data across generations. Saves and loads agent configuration
 * for self-improvement continuity.
 */
@Service
public class EvolutionPersistence {
  ...
  public AgentConfig loadBestConfig() {
    ...
    try (FileInputStream in = new FileInputStream(saveFilePath)) {
      ...
      log.info(
          "Loaded previous evolution data from generation: {}",
          props.getProperty("generation", "0"));
