...
public class SkillDiscoveryController {
     ...
     * Admin can pass a URL, and the system will scrape it, extract the skill, 
     * and push it to the MCP Marketplace Pending Queue.
     */
    ...
    public ResponseEntity<?> triggerOnDemandLearning(@RequestBody Map<String, String> request) {
        ...
        return ResponseEntity.ok(Map.of(
            "message", "On-demand learning triggered successfully. The skill will appear in the 'Pending Approvals' queue once processed.",
            "target_url", url
        ));
    }
}