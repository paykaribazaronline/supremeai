 ...
 *
 * <p>Decorates AIProvider instances to automatically record performance metrics (latency,
 * success/failure) to the self-learning router.
 */
@Component
public class TrackingAIProviderDecorator {
  ...
  private static class TrackingProvider implements AIProvider {
    ...
    TrackingProvider(
        AIProvider delegate, String providerName, AIProviderPerformanceTracker tracker) {
