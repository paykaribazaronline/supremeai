...
/**
 * Centralized utility class for fallback constants. Avoids duplicated Bangla response strings
...
public final class FallbackConstants {
  ...
  /**
   * Default Bangla message when all AI providers are unavailable/fail to respond, triggering system
   * solo mode active notification.
   */
