...
public class InfrastructureAdvice {
  ...
  public InfrastructureAdvice(
      ...
      List<HostingComponent> components,
      List<String> securityBestPractices,
      List<String> scalabilityTips,
      String summary,
      Long createdAt) {
    this.id = id;
    this.appId = appId;
  ...
  public List<HostingComponent> getComponents() {
    return components;
  }

  public void setComponents(List<HostingComponent> components) {
    this.components = components;
  }

  public List<String> getSecurityBestPractices() {
    return securityBestPractices;
  }

  public void setSecurityBestPractices(List<String> securityBestPractices) {
    this.securityBestPractices = securityBestPractices;
  }

  public List<String> getScalabilityTips() {
    return scalabilityTips;
  }

  public void setScalabilityTips(List<String> scalabilityTips) {
    this.scalabilityTips = scalabilityTips;
  }
  ...
  public static class InfrastructureAdviceBuilder {
    ...
    public InfrastructureAdviceBuilder id(String id) {
      this.id = id;
      return this;
    }

    public InfrastructureAdviceBuilder appId(String appId) {
      this.appId = appId;
      return this;
    }

    public InfrastructureAdviceBuilder appName(String appName) {
      this.appName = appName;
      return this;
    }

    public InfrastructureAdviceBuilder recommendedProvider(String recommendedProvider) {
      this.recommendedProvider = recommendedProvider;
      return this;
    }

    public InfrastructureAdviceBuilder recommendedTier(String recommendedTier) {
      this.recommendedTier = recommendedTier;
      return this;
    }

    public InfrastructureAdviceBuilder estimatedMonthlyCost(Double estimatedMonthlyCost) {
      this.estimatedMonthlyCost = estimatedMonthlyCost;
      return this;
    }

    public InfrastructureAdviceBuilder components(List<HostingComponent> components) {
      this.components = components;
      return this;
    }

    public InfrastructureAdviceBuilder securityBestPractices(List<String> securityBestPractices) {
      this.securityBestPractices = securityBestPractices;
      return this;
    }

    public InfrastructureAdviceBuilder scalabilityTips(List<String> scalabilityTips) {
      this.scalabilityTips = scalabilityTips;
      return this;
    }

    public InfrastructureAdviceBuilder summary(String summary) {
      this.summary = summary;
      return this;
    }

    public InfrastructureAdviceBuilder createdAt(Long createdAt) {
      this.createdAt = createdAt;
      return this;
    }
  ...
  public static class HostingComponent {
    ...
    public static class HostingComponentBuilder {
      ...
      public HostingComponentBuilder name(String name) {
        this.name = name;
        return this;
      }

      public HostingComponentBuilder service(String service) {
        this.service = service;
        return this;
      }

      public HostingComponentBuilder reason(String reason) {
        this.reason = reason;
        return this;
      }
