...
/**
 * Defines the access levels for SupremeAI users. Quotas for these tiers are managed dynamically via
 * SystemConfig.
 */
public enum UserTier {
  ...
  /**
   * Default monthly quota for each tier (in API calls or tokens) Note: Actual quotas may be
   * overridden by SystemConfig.
   */
