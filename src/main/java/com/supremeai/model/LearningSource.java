...
public class LearningSource {
  ...
  public String getDetectedFocus() {
    return detectedFocus;
  }

  public void setDetectedFocus(String detectedFocus) {
    this.detectedFocus = detectedFocus;
  }
  ...
  public void setManualFocus(String manualFocus) {
  ...
  public Date getLastScrapedAt() {
    return lastScrapedAt;
  }

  public void setLastScrapedAt(Date lastScrapedAt) {
