...
/** Reverse engineering job stored in Firestore. Collection: "reverse_engineering_jobs" */
public class ReverseEngineeringJob {

  @Id @DocumentId private String jobId;
  ...
  public Map<String, Object> getDiscoveredApis() {
    return discoveredApis;
  }

  public void setDiscoveredApis(Map<String, Object> discoveredApis) {
  ...
  public void setScrapedData(Map<String, Object> scrapedData) {
    this.scrapedData = scrapedData;
  }

  public String getGeneratedAppId() {
    return generatedAppId;
  }

  public void setGeneratedAppId(String generatedAppId) {
