...
/**
 * Metadata for files stored in external storage (Telegram/Supabase).
 * This is stored in Firestore to allow the dashboard to list and manage these files.
...
public class StorageMetadata {
    ...
    public StorageMetadata(String fileName, String remotePath, String storageProvider, String category, long size) {
        this();
