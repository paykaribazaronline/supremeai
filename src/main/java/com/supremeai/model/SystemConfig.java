...
/**
 * Global system configuration stored in Firestore. This allows administrators to change quotas and
 * AI settings in real-time. Collection: "system_configs", Document ID: "global_settings"
 */
@Document(collectionName = "system_configs")
public class SystemConfig {

  @DocumentId private String id = "global_settings";
  ...
  public Map<String, Long> getTierQuotas() {
    return tierQuotas;
  }

  public void setTierQuotas(Map<String, Long> tierQuotas) {
    this.tierQuotas = tierQuotas;
  }

  public Map<String, Integer> getTierMaxApis() {
    return tierMaxApis;
  }

  public void setTierMaxApis(Map<String, Integer> tierMaxApis) {
    this.tierMaxApis = tierMaxApis;
  }

  public Map<String, Integer> getTierMaxSimulatorInstalls() {
    return tierMaxSimulatorInstalls;
  }

  public void setTierMaxSimulatorInstalls(Map<String, Integer> tierMaxSimulatorInstalls) {
    this.tierMaxSimulatorInstalls = tierMaxSimulatorInstalls;
  }
  ...
  public boolean isApiAccessLock() {
    return apiAccessLock;
  }

  public void setApiAccessLock(boolean apiAccessLock) {
    this.apiAccessLock = apiAccessLock;
  }

  public String getApiRotationStrategy() {
    return apiRotationStrategy;
  }

  public void setApiRotationStrategy(String apiRotationStrategy) {
    this.apiRotationStrategy = apiRotationStrategy;
  }
  ...
  public void setAutoExecApprovalRequired(Object autoExecApprovalRequired) {
    this.autoExecApprovalRequired = autoExecApprovalRequired;
  }
  ...
  public boolean isEnableExternalDirectory() {
    return enableExternalDirectory;
  }

  public void setEnableExternalDirectory(boolean enableExternalDirectory) {
    this.enableExternalDirectory = enableExternalDirectory;
  }
  ...
  public boolean isAutonomousLearningEnabled() {
    return autonomousLearningEnabled;
  }

  public void setAutonomousLearningEnabled(boolean autonomousLearningEnabled) {
    this.autonomousLearningEnabled = autonomousLearningEnabled;
  }

  public boolean isAutonomousAuditEnabled() {
    return autonomousAuditEnabled;
  }

  public void setAutonomousAuditEnabled(boolean autonomousAuditEnabled) {
    this.autonomousAuditEnabled = autonomousAuditEnabled;
  }
  ...
  public void setTelegramConfig(Map<String, Object> telegramConfig) {
    this.telegramConfig = telegramConfig;
  }

  public Map<String, Object> getSupabaseConfig() {
    return supabaseConfig;
  }

  public void setSupabaseConfig(Map<String, Object> supabaseConfig) {
  ...
  /**
   * Helper to get a secret value for a specific provider. Expects the secret to be stored in the
   * 'providers' map under providerName -> secretKey.
   *
