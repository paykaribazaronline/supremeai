...
public class UserSimulatorProfile {
    ...
    public UserSimulatorProfile(String userId, int installQuota, int activeInstalls, List<InstalledApp> installedApps, 
                                ActiveSession currentSession, LocalDateTime lastActiveAt, String activeSessionId, 
                                Map<String, Object> deviceConfig, long lastUsedTimestamp, Map<String, Long> appExpiryMap, 
                                LocalDateTime lastActiveTimestamp, UserTier userTier) {
        this.userId = userId;
    ...
    public void setDeviceConfig(Map<String, Object> deviceConfig) { this.deviceConfig = deviceConfig != null ? deviceConfig : new HashMap<>(); }
    ...
    public Map<String, Long> getAppExpiryMap() { return appExpiryMap; }
    public void setAppExpiryMap(Map<String, Long> appExpiryMap) { this.appExpiryMap = appExpiryMap != null ? appExpiryMap : new HashMap<>(); }

    public LocalDateTime getLastActiveTimestamp() { return lastActiveTimestamp; }
    public void setLastActiveTimestamp(LocalDateTime lastActiveTimestamp) { this.lastActiveTimestamp = lastActiveTimestamp; }

    public UserTier getUserTier() { return userTier; }
    public void setUserTier(UserTier userTier) { this.userTier = userTier != null ? userTier : UserTier.BASIC; }
    ...
    public static class UserSimulatorProfileBuilder {
        ...
        public UserSimulatorProfileBuilder userId(String userId) { this.userId = userId; return this; }
        public UserSimulatorProfileBuilder installQuota(int installQuota) { this.installQuota = installQuota; return this; }
        public UserSimulatorProfileBuilder activeInstalls(int activeInstalls) { this.activeInstalls = activeInstalls; return this; }
        public UserSimulatorProfileBuilder installedApps(List<InstalledApp> installedApps) { this.installedApps = installedApps; return this; }
        public UserSimulatorProfileBuilder currentSession(ActiveSession currentSession) { this.currentSession = currentSession; return this; }
        public UserSimulatorProfileBuilder lastActiveAt(LocalDateTime lastActiveAt) { this.lastActiveAt = lastActiveAt; return this; }
        public UserSimulatorProfileBuilder activeSessionId(String activeSessionId) { this.activeSessionId = activeSessionId; return this; }
        public UserSimulatorProfileBuilder deviceConfig(Map<String, Object> deviceConfig) { this.deviceConfig = deviceConfig; return this; }
        public UserSimulatorProfileBuilder lastUsedTimestamp(long lastUsedTimestamp) { this.lastUsedTimestamp = lastUsedTimestamp; return this; }
        public UserSimulatorProfileBuilder appExpiryMap(Map<String, Long> appExpiryMap) { this.appExpiryMap = appExpiryMap; return this; }
        public UserSimulatorProfileBuilder lastActiveTimestamp(LocalDateTime lastActiveTimestamp) { this.lastActiveTimestamp = lastActiveTimestamp; return this; }
        public UserSimulatorProfileBuilder userTier(UserTier userTier) { this.userTier = userTier; return this; }

        public UserSimulatorProfile build() {
            return new UserSimulatorProfile(userId, installQuota, activeInstalls, installedApps, currentSession, 
                                            lastActiveAt, activeSessionId, deviceConfig, lastUsedTimestamp, 
                                            appExpiryMap, lastActiveTimestamp, userTier);
        }
    }
    ...
    public static class InstalledApp {
        ...
        public InstalledApp(String appId, String appName, String version, String deployedUrl, 
                            LocalDateTime installedAt, AppStatus status, int launchCount, LocalDateTime lastLaunchedAt) {
            this.appId = appId;
            this.appName = appName;
            this.version = version;
            this.deployedUrl = deployedUrl;
    ...
    public static class ActiveSession {
        ...
        public ActiveSession(String sessionId, String activeAppId, String sessionUrl, 
                             LocalDateTime startedAt, LocalDateTime lastHeartbeat, SessionState state) {
            this.sessionId = sessionId;
            this.activeAppId = activeAppId;
            this.sessionUrl = sessionUrl;
