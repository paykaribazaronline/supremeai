...
/** Simulator deployment record stored in Firestore. Collection: "simulator_deployments" */
...
public class SimulatorDeploymentRecord {
  ...
  @ServerTimestamp private LocalDateTime deployedAt;

  public SimulatorDeploymentRecord() {}

  public SimulatorDeploymentRecord(
      String appId, String deviceType, String previewUrl, String status) {
    this.appId = appId;
