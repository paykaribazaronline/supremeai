...
public class AnalysisBaseline {
  ...
  public String getFindingsHash() {
    return findingsHash;
  }

  public void setFindingsHash(String findingsHash) {
    this.findingsHash = findingsHash;
  }
  ...
  public static class AnalysisBaselineBuilder {
    ...
    public AnalysisBaselineBuilder id(String id) {
      this.id = id;
      return this;
    }

    public AnalysisBaselineBuilder projectId(String projectId) {
      this.projectId = projectId;
      return this;
    }

    public AnalysisBaselineBuilder commitHash(String commitHash) {
      this.commitHash = commitHash;
      return this;
    }

    public AnalysisBaselineBuilder findingsHash(String findingsHash) {
      this.findingsHash = findingsHash;
      return this;
    }

    public AnalysisBaselineBuilder findings(List<AnalysisFinding> findings) {
      this.findings = findings;
      return this;
    }

    public AnalysisBaselineBuilder createdAt(String createdAt) {
      this.createdAt = createdAt;
      return this;
    }
