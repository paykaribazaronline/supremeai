...
public class AIBehaviorProfile {
  ...
  public AIBehaviorProfile(
      ...
      SecurityStrictness securityStrictness,
  ...
  public SecurityStrictness getSecurityStrictness() {
    return securityStrictness;
  }

  public void setSecurityStrictness(SecurityStrictness securityStrictness) {
    this.securityStrictness = securityStrictness;
  }

  public PerformanceTradeoff getPerformanceTradeoff() {
    return performanceTradeoff;
  }

  public void setPerformanceTradeoff(PerformanceTradeoff performanceTradeoff) {
    this.performanceTradeoff = performanceTradeoff;
  }
