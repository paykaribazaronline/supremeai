...
public class ConsensusVote {
  ...
  public void setConsensusAnswer(String consensusAnswer) {
    this.consensusAnswer = consensusAnswer;
  }
  ...
  public String getConsensusStrength() {
    return consensusStrength;
  }

  public void setConsensusStrength(String consensusStrength) {
    this.consensusStrength = consensusStrength;
  }

  public List<ProviderVote> getVotes() {
    return votes;
  }

  public void setVotes(List<ProviderVote> votes) {
    this.votes = votes;
  }
