...
/**
 * Firestore-backed configuration for each UserTier.
 * Stored in collection "user_tiers" — one document per tier.
 * Maps to the UserTier enum for business logic.
 */
...
public class UserTierConfig {
    ...
    public UserTierConfig(String id, String description, long defaultMonthlyQuota,
                          boolean premium, boolean unlimited) {
        this.id = id;
    ...
    public long getDefaultMonthlyQuota() { return defaultMonthlyQuota; }
    public void setDefaultMonthlyQuota(long defaultMonthlyQuota) { this.defaultMonthlyQuota = defaultMonthlyQuota; }
