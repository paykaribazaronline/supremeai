...
public class SuperFlyConfig {
    ...
    @DocumentId
    private String id = "superfly_settings";

    private String downloadUrl = "https://github.com/your-github-user/supremeai/releases/download/v2.0/superfly-94m.onnx";
    private String fileSize = "188 MB";
    private String version = "v1.0.0";
    private List<String> benefits = new ArrayList<>();
    private String guideline = "### SuperFly এজ এআই নির্দেশিকা\n\n" +
