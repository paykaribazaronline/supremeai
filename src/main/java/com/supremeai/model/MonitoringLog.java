...
public class MonitoringLog {
    ...
    public static class MonitoringLogBuilder {
        ...
        public MonitoringLogBuilder id(String id) { this.id = id; return this; }
        public MonitoringLogBuilder level(String level) { this.level = level; return this; }
        public MonitoringLogBuilder component(String component) { this.component = component; return this; }
        public MonitoringLogBuilder message(String message) { this.message = message; return this; }
        public MonitoringLogBuilder timestamp(long timestamp) { this.timestamp = timestamp; return this; }
