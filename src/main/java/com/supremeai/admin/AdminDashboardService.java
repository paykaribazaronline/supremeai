...
public class AdminDashboardService {
    ...
    public void setAutoPilot(boolean enabled) {
        ...
        System.out.println("[Admin] Auto Pilot mode set to: " + (enabled ? "ON" : "OFF"));
    }
    ...
    public boolean submitImprovement(ImprovementProposal proposal) {
        if (isAutoPilotEnabled) {
            ...
            System.out.println("[Admin Dashboard] " + notification);
            ...
            System.out.println("[Admin Dashboard] New Permission Request: " + proposal.getTitle() + ". Waiting for Admin approval.");
    ...
    public boolean approveProposal(String proposalId) {
        ...
        if (proposal != null) {
            proposal.approve();
            System.out.println("[Admin Dashboard] Admin manually APPROVED: " + proposal.getTitle());
    ...
    public boolean rejectProposal(String proposalId) {
        ImprovementProposal proposal = pendingApprovals.remove(proposalId);
        if (proposal != null) {
            System.out.println("[Admin Dashboard] Admin REJECTED: " + proposal.getTitle());
            return true;
        }
        return false;
    }
