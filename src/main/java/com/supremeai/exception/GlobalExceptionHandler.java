...
public class GlobalExceptionHandler {
   ...
   *
   * <p>- SPA frontend paths (/admin/**): forward to index.html so React Router can handle routing.
   * - API paths (/api/**): return a proper JSON 404 — not a 500. - Anything else: return a 404.
   *
   * <p>WITHOUT this handler, Spring's catch-all below converts these to a confusing 500 JSON error.
   */
  ...
  public void handleNoResourceFound(
    ...
    if (path.startsWith("/api/")) {
      ...
      response
          .getWriter()
          .write("{\"success\":false,\"error\":\"Not found\",\"path\":\"" + path + "\"}");
