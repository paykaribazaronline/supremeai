...
/**
 * Service to retrieve secrets from Firebase Firestore. It looks into the 'system_configs'
 * collection, 'global_settings' document.
 */
@Service
public class FirebaseSecretsService {
  ...
  /**
   * Retrieve a secret from Firebase. Checks Firestore first, then falls back to Realtime Database.
   *
