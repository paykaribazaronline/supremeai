...
/**
 * Service to manage secrets using Google Cloud Secret Manager. Falls back to environment variables
 * if Secret Manager is not available or if in local mode.
 */
@Service
public class SecretManagerService {
  ...
  public String getSecret(String secretId) {
    ...
    if (isProduction()) {
      log.error(
          "CRITICAL SECURITY AUDIT FAILURE: Env var fallback for secret '{}' is BLOCKED in production!",
          secretId);
      return null;
    }
