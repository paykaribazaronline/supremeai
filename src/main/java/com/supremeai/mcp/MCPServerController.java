...
public class MCPServerController {
     ...
     */
    @PostMapping(value = "/resources/list", consumes = "application/json", produces = "application/json")
     ...
     */
    @PostMapping(value = "/resources/read", consumes = "application/json", produces = "application/json")
    public Map<String, Object> readResource(@RequestBody Map<String, Object> request) {
        ...
        try {
            if ("supremeai://plans/23".equals(uri)) {
                String path = "/home/nazifarabbu/supremeai/final_document/main plan/Plan_23_Website_Reverse_Engineering_Master_Guide.md";
                ...
                String path = "/home/nazifarabbu/supremeai/final_document/main plan/Plan_24_AI_Agent_Ecosystem_Integration.md";
                String content = Files.readString(Paths.get(path));
                contents.add(Map.of(
                    "uri", uri,
                    "mimeType", "text/markdown",
     ...
     */
    @PostMapping(value = "/prompts/list", consumes = "application/json", produces = "application/json")
        ...
        if ("reverse_engineer_prompt".equals(name)) {
            ...
            response.put("messages", List.of(
                Map.of(
                    ...
                    "content", Map.of(
                        "type", "text",
                        "text", "Please reverse engineer the following website and generate a connector: " + url
                    )
                )
            ));
        } else {
