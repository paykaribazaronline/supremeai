...
/**
 * JVM Options configuration for optimal performance. Recommended JVM arguments for production:
 *
 * <p>Heap Size: -Xms4g -Xmx8g GC Tuning: -XX:+UseZGC or -XX:+UseG1GC Virtual Threads:
 * -XX:+UnlockExperimentalVMOptions (Java 19-20)
 *
 * <p>Example: java -Xms4g -Xmx8g -XX:+UseZGC -XX:+UnlockExperimentalVMOptions -jar app.jar
 */
public class JVMOptionsConfig implements EnvironmentPostProcessor {
  ...
  public void postProcessEnvironment(
    ...
    environment.getPropertySources().addLast(new PropertiesPropertySource("jvmOptions", props));
  }
}
