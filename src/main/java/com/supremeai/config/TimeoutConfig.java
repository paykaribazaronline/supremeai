...
/**
 * Provider-specific timeout configuration. Timeout categories (provider type names) are sourced
 * from application.yml under {@code provider.timeouts.{connect,read,write}}.
 *
 * <p>Per-provider timeouts must be configured there — no brand names are hardcoded here.
 */
@Configuration
...
public class TimeoutConfig {
  ...
  public Map<String, Duration> getConnect() {
    return connect;
  }

  public void setConnect(Map<String, Duration> connect) {
    this.connect = connect;
  }

  public Map<String, Duration> getRead() {
    return read;
  }

  public void setRead(Map<String, Duration> read) {
    this.read = read;
  }

  public Map<String, Duration> getWrite() {
    return write;
  }

  public void setWrite(Map<String, Duration> write) {
    this.write = write;
  }
}
