...
/**
 * Circuit breaker configuration with metrics and half-open state testing. Provides automatic
 * failover and recovery for external AI providers.
 */
@Configuration
public class ExternalServiceResilienceConfig {
  ...
  /**
   * Get or create a circuit breaker for a provider by name at runtime. Provider names are resolved
   * from Firestore via the ProviderTypeRegistry — no provider brand name is hardcoded here.
   */
  @Bean
