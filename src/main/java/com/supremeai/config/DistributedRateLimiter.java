...
/**
 * Distributed rate limiter using Redis for cluster-wide rate limiting. Uses Redis Lua script for
 * atomic operations to ensure accuracy in distributed environments.
 */
@Component
public class DistributedRateLimiter {
  ...
  /**
   * Try to acquire a permit for the given key. Uses token bucket algorithm for smooth rate
   * limiting.
   *
