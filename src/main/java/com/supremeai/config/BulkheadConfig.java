...
/**
 * Bulkhead pattern configuration for AI provider isolation. Each provider gets its own thread pool
...
public class BulkheadConfig {
  ...
  /**
   * Thread pool for OpenAI provider Isolated to prevent OpenAI issues from affecting other
   * providers
   */
  ...
  /** Thread pool for Groq provider Fast provider with lower timeout requirements */
  ...
  /** Thread pool for local/Ollama provider Higher resource requirements, separate pool */
