...
public class VotingDecision {
  ...
  public String getAiConsensus() {
    return aiConsensus;
  }

  public void setAiConsensus(String aiConsensus) {
    this.aiConsensus = aiConsensus;
  }
  ...
  public List<ProviderVote> getProviderVotes() {
    return providerVotes;
  }

  public void setProviderVotes(List<ProviderVote> providerVotes) {
    this.providerVotes = providerVotes;
  }
}
