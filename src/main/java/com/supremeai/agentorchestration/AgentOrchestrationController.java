...
public class AgentOrchestrationController {
  ...
  @Autowired private com.supremeai.service.AppOrchestrationService orchestrationService;

  @Autowired private CodeGenerationService codeGenerationService;

  @Autowired private com.supremeai.agent.GPublishAgent publishAgent;
  ...
  public Mono<ResponseEntity<Object>> orchestrate(@RequestBody Map<String, Object> request) {
    ...
    if (requirement == null || requirement.trim().isEmpty()) {
      return Mono.just(
          ResponseEntity.badRequest().body(Map.of("error", "Requirement is required")));
    }
      ...
      return Mono.just(
          ResponseEntity.status(503)
              .body(
                  Map.of(
                      "error",
                      "Orchestrator unavailable in local mode. Set up Firestore credentials.")));
    }
  ...
  public Mono<ResponseEntity<Object>> orchestrateAndGenerate(
    ...
    return orchestrationService
        .runFullPipeline(requirement, githubConfig)
  ...
  @SuppressWarnings("unchecked")
  public Mono<ResponseEntity<Object>> generateWithContext(
      @RequestBody Map<String, Object> request) {
    Map<String, Object> context = (Map<String, Object>) request.get("context");
    if (context == null) {
      return Mono.just(ResponseEntity.badRequest().body(Map.of("error", "Context is required")));
    }
  ...
  /**
   * পাবলিশিং প্ল্যান তৈরি এন্ডপয়েন্ট প্ল্যাটফর্ম এবং কনফিগারেশন অনুযায়ী পাবলিশিং প্ল্যান তৈরি করে
   */
  @PostMapping("/publishing-plan")
  @SuppressWarnings("unchecked")
  public Mono<ResponseEntity<Object>> createPublishingPlan(
      @RequestBody Map<String, Object> request) {
    String platform = (String) request.get("platform");
    Map<String, String> config = (Map<String, String>) request.get("config");

    if (platform == null || platform.trim().isEmpty()) {
      return Mono.just(ResponseEntity.badRequest().body(Map.of("error", "Platform is required")));
    }
