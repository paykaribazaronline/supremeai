...
/** EWebAgent - Web Application Agent এই এজেন্টটি ওয়েব অ্যাপ তৈরির জন্য দায়িত্বপ্রাপ্ত */
@Service
public class EWebAgent {
  ...
  public List<Question> analyzeWebRequirements(String requirement) {
    try {
      ...
      String prompt =
          "একটি ওয়েব অ্যাপের জন্য নিম্নলিখিত প্রয়োজনীয়তা বিশ্লেষণ করুন: \""
              + requirement
              + "\"\n"
      ...
      logger.warn(
          "ওয়েব প্রয়োজনীয়তা বিশ্লেষণ ব্যর্থ হয়েছে, ডিফল্ট প্রশ্নগুলি ব্যবহার করা হচ্ছে: {}",
          e.getMessage());
  ...
  private List<Question> getDefaultWebQuestions() {
    ...
    questions.add(
        new Question(
            "webFramework",
            "কোন ওয়েব ফ্রেমওয়ার্ক ব্যবহার করবেন? (React, Vue, Angular, Next.js)",
            "HIGH"));
    questions.add(
        new Question(
            "webLanguage",
            "কোন প্রোগ্রামিং ভাষা ব্যবহার করবেন? (JavaScript, TypeScript)",
            "CRITICAL"));
    questions.add(
        new Question(
            "webStyling",
            "স্টাইলিংয়ের জন্য কী ব্যবহার করবেন? (CSS, SCSS, Tailwind, Styled Components)",
            "MEDIUM"));
    questions.add(
        new Question(
            "webStateManagement",
            "স্টেট ম্যানেজমেন্টের জন্য কী ব্যবহার করবেন? (Redux, MobX, Context API, Zustand)",
            "HIGH"));
    questions.add(
        new Question(
            "webBuildTool",
            "বিল্ড টুল হিসেবে কী ব্যবহার করবেন? (Vite, Webpack, Parcel)",
            "MEDIUM"));
    questions.add(
        new Question(
            "webDeployment",
            "ওয়েব অ্যাপ ডিপ্লয়মেন্ট কোথায় করবেন? (Vercel, Netlify, AWS, GCP)",
            "HIGH"));
    return questions;
  }
