...
/** DiOSAgent - Desktop iOS Agent এই এজেন্টটি ডেস্কটপ এবং iOS অ্যাপ তৈরির জন্য দায়িত্বপ্রাপ্ত */
@Service
public class DiOSAgent {
  ...
  public List<Question> analyzeIOSRequirements(String requirement) {
    try {
      ...
      String rawPrompt =
          "একটি iOS অ্যাপের জন্য নিম্নলিখিত প্রয়োজনীয়তা বিশ্লেষণ করুন: "
              + requirement
              + "\n"
      ...
      logger.warn(
          "iOS প্রয়োজনীয়তা বিশ্লেষণ ব্যর্থ হয়েছে, ডিফল্ট প্রশ্নগুলি ব্যবহার করা হচ্ছে: {}",
          e.getMessage());
  ...
  public List<Question> analyzeDesktopRequirements(String requirement) {
    try {
      AIProvider provider = providerFactory.getDefaultProvider();
      String rawPrompt =
          "একটি ডেস্কটপ অ্যাপের জন্য নিম্নলিখিত প্রয়োজনীয়তা বিশ্লেষণ করুন: "
              + requirement
              + "\n"
      ...
      logger.warn(
          "ডেস্কটপ প্রয়োজনীয়তা বিশ্লেষণ ব্যর্থ হয়েছে, ডিফল্ট প্রশ্নগুলি ব্যবহার করা হচ্ছে: {}",
          e.getMessage());
  ...
  private List<Question> getDefaultIOSQuestions() {
    ...
    questions.add(
        new Question(
            "iosFramework",
            "কোন iOS ফ্রেমওয়ার্ক ব্যবহার করবেন? (SwiftUI, UIKit, Flutter)",
            "HIGH"));
    questions.add(
        new Question(
            "iosLanguage",
            "কোন প্রোগ্রামিং ভাষা ব্যবহার করবেন? (Swift, Objective-C, Dart)",
            "CRITICAL"));
    questions.add(
        new Question(
            "iosArchitecture", "iOS অ্যাপের আর্কিটেকচার কেমন হবে? (MVVM, MVC, VIPER)", "HIGH"));
    questions.add(
        new Question(
            "iosDataStorage",
            "ডেটা সংরক্ষণের জন্য কী ব্যবহার করবেন? (CoreData, Realm, SQLite)",
            "MEDIUM"));
    questions.add(
        new Question(
            "iosNetworking",
            "নেটওয়ার্কিংয়ের জন্য কী ব্যবহার করবেন? (URLSession, Alamofire)",
            "MEDIUM"));
    questions.add(
        new Question(
            "iosDeployment",
            "iOS অ্যাপ ডিপ্লয়মেন্ট কীভাবে করবেন? (App Store, TestFlight, Enterprise)",
            "HIGH"));
    return questions;
  }
  ...
  private List<Question> getDefaultDesktopQuestions() {
    ...
    questions.add(
        new Question(
            "desktopFramework",
            "কোন ডেস্কটপ ফ্রেমওয়ার্ক ব্যবহার করবেন? (Electron, Tauri, JavaFX)",
            "HIGH"));
    questions.add(
        new Question(
            "desktopLanguage",
            "কোন প্রোগ্রামিং ভাষা ব্যবহার করবেন? (JavaScript, Rust, Java)",
            "CRITICAL"));
    questions.add(
        new Question(
            "desktopArchitecture",
            "ডেস্কটপ অ্যাপের আর্কিটেকচার কেমন হবে? (MVC, MVVM, Clean Architecture)",
            "HIGH"));
    questions.add(
        new Question(
            "desktopDataStorage",
            "ডেটা সংরক্ষণের জন্য কী ব্যবহার করবেন? (SQLite, IndexedDB, File System)",
            "MEDIUM"));
    questions.add(
        new Question(
            "desktopPackaging", "অ্যাপ প্যাকেজিং কীভাবে করবেন? (MSI, DMG, AppImage)", "MEDIUM"));
    questions.add(
        new Question(
            "desktopUpdate", "অ্যাপ আপডেট সিস্টেম কীভাবে হবে? (Auto-updater, Manual)", "LOW"));
    return questions;
  }
