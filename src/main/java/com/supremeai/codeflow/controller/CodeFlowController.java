...
/**
 * REST API Controller for CodeFlow module Provides endpoints for code analysis, visualization, and
 * error resolution
 */
@RestController
...
public class CodeFlowController {
  ...
  /** Analyze a repository POST /api/codeflow/analyze */
  @PostMapping("/analyze")
  public ResponseEntity<Map<String, Object>> analyzeRepository(
    ...
    try {
      CodeRepository result =
          codeFlowService.analyzeRepository(
              request.getRepoUrl(), request.getSourceType(), request.getOwnerId());
  ...
  /** Get analysis results GET /api/codeflow/analysis/{repositoryId} */
  ...
  /** Get analyses for owner GET /api/codeflow/owner/{ownerId} */
  ...
  /** Analyze pull request impact POST /api/codeflow/pr/analyze */
  ...
  public ResponseEntity<Map<String, Object>> analyzePullRequest(
    ...
    try {
      CodeRepository.PullRequestAnalysis analysis =
          codeFlowService.analyzePullRequest(request.getRepositoryId(), request.getChangedFiles());
  ...
  /** Get health score GET /api/codeflow/health/{repositoryId} */
  ...
  /** Get dependency graph GET /api/codeflow/graph/{repositoryId} */
  ...
  /** Get security issues GET /api/codeflow/security/{repositoryId} */
  ...
  /** Get AI suggestions GET /api/codeflow/suggestions/{repositoryId} */
  ...
  /** Get dead code report GET /api/codeflow/deadcode/{repositoryId} */
  ...
  /** Get pattern detection results GET /api/codeflow/patterns/{repositoryId} */
  ...
  /** Export analysis as JSON GET /api/codeflow/export/json/{repositoryId} */
  ...
  /** Re-analyze repository POST /api/codeflow/reanalyze/{repositoryId} */
  ...
  /** Health check endpoint GET /api/codeflow/health */
  @GetMapping("/health")
