...
/**
 * Predicts what the developer is trying to build before they even finish typing. Like an
 * ultra-advanced GitHub Copilot.
 */
@Service
public class IntentPredictor {
  ...
  public String predictNextMove(String currentCode, String partialPrompt) {
    ...
    if (currentCode.contains("interface")
        && currentCode.contains("extends JpaRepository")
        && partialPrompt.toLowerCase().contains("service")) {
