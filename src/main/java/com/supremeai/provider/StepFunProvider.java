...
/**
 * StepFun (阶跃星辰) Provider implementation using shared HTTP client and ObjectMapper. Extends
 * AbstractHttpProvider for optimized performance. Free tier available: https://platform.stepfun.com
...
public class StepFunProvider extends AbstractHttpProvider {
  ...
  /** Constructor with default model (step-3.5-flash) Use this for free tier access */
  ...
  public Map<String, Object> getCapabilities() {
    return Map.of(
        ...
        "StepFun",
        "models",
        List.of("step-3.5-flash", "step-3.5-pro", "step-1"),
        "freeTier",
        "10k-50k tokens/day",
        "rateLimit",
        "10-30 RPM",
        "supports",
        List.of("chat", "code", "reasoning", "multimodal"),
        "languages",
        List.of("zh", "en", "multi"),
        "baseUrl",
        API_URL);
  ...
  protected Map<String, Object> createRequestBody(String prompt) {
    return Map.of(
        "messages", List.of(Map.of("role", "user", "content", prompt)), "model", defaultModel);
  }
