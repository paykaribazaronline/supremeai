...
/**
 * Kimi (Moonshot AI) Provider implementation using shared HTTP client and ObjectMapper. Extends
...
public class KimiProvider extends AbstractHttpProvider {
  ...
  public KimiProvider() {
    this("", "moonshot-v1-128k");
  }

  public KimiProvider(@Value("${kimi.api-key:}") String apiKey) {
