...
/**
 * Standard provider for all Google Generative AI (v1beta/v1) compatible APIs. This class replaces
 * model-specific providers like GeminiProvider.
 */
public class GoogleGenerativeProvider extends AbstractHttpProvider {
  private final String providerName;

  public GoogleGenerativeProvider(
      String apiKey, String baseUrl, String model, String providerName) {
