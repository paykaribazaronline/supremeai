...
/**
 * Groq Provider implementation using shared HTTP client and ObjectMapper. Extends
...
public class GroqProvider extends AbstractHttpProvider {
  ...
  public GroqProvider(String apiKey, String baseUrl, String model) {
    super(
        ...
        model != null && !model.isEmpty() ? model : "mixtral-8x7b-32768");
  }
  ...
  public Map<String, Object> getCapabilities() {
    return Map.of(
        ...
        "Groq",
        "models",
        new String[] {"llama2-70b-4096", "mixtral-8x7b-32768", "gemma-7b-it"});
  }
