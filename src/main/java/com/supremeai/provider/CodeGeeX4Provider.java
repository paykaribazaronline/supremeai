...
/**
 * CodeGeeX4 Provider implementation using shared HTTP client and ObjectMapper. Extends
 * AbstractHttpProvider for optimized performance. Cloud API from BigModel.cn (智谱AI) -
 * Code-specialized 9B model with 128K context Free tier available: https://bigmodel.cn Uses
...
public class CodeGeeX4Provider extends AbstractHttpProvider {
  ...
  /** Constructor with default model (codegeex-4) Use this for cloud API access */
    ...
    return Map.of(
        ...
        List.of(
            Map.of(
                "role", "system",
                "content",
                    "You are CodeGeeX, an intelligent programming assistant. You provide accurate, executable code with explanations when needed."),
