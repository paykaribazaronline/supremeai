...
/**
 * প্রোভাইডার সুইচিং মেকানিজম যা ব্যবহারকারীর পছন্দ অনুযায়ী স্বয়ংক্রিয়ভাবে প্রোভাইডার পরিবর্তন
 * করতে পারে। এটি প্রতিটি প্রোভাইডারের পারফরম্যান্স ট্র্যাক করে এবং সেরা প্রোভাইডার নির্বাচন করে।
 */
@Service
public class AIProviderSwitcher {
  ...
  public String switchProvider(
      String currentProvider, String taskCategory, String prompt, String userId) {
    logger.info(
        "Provider switch initiated for user: {}, current provider: {}, task: {}",
        userId,
        currentProvider,
        taskCategory);
    ...
    if (bestProvider != null && !bestProvider.equals(currentProvider)) {
      logger.info(
          "Switching to best performing provider: {} for task: {}", bestProvider, taskCategory);
    ...
    return resolveResponse(
        fallbackOrchestrator.executeWithSupremeIntelligence(
            taskCategory, "provider_switch", prompt, userId));
  }

  /** নির্দিষ্ট প্রোভাইডার দিয়ে কাজ সম্পন্ন করা */
  private String executeWithProvider(
      String providerName, String taskCategory, String prompt, String userId) {
    try {
      ...
      return resolveResponse(
          fallbackOrchestrator.executeWithSupremeIntelligence(
              taskCategory, "provider_error:" + providerName, prompt, userId));
    }
  }
  ...
  public void recordProviderPerformance(
      String providerName, String taskCategory, boolean success, long responseTime) {
    providerMetrics
        .computeIfAbsent(
            providerName + ":" + taskCategory, k -> new ProviderMetrics(providerName, taskCategory))
