...
/**
 * Decorator for AIProvider that automatically attaches global agent rules to every prompt. This
 * ensures system-wide adherence to the AGENTS.md guidelines.
 */
public class RuleEnforcingAIProvider implements AIProvider {
  ...
  public Mono<String> generate(String prompt) {
    ...
    return ruleService.enrichPrompt(prompt, "build").flatMap(delegate::generate);
  }
}
