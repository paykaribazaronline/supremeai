...
/**
 * Ollama Provider implementation using shared HTTP client and ObjectMapper. Extends
 * AbstractHttpProvider for optimized performance. Connects to local Ollama server for free, offline
 * AI inference. (অফলাইন এআই ইনফারেন্সের জন্য লোকাল ওলামা সার্ভারের সাথে সংযোগ স্থাপন করে)
 */
@Component
