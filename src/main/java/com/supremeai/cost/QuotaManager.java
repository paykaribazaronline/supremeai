...
public class QuotaManager {
  ...
  private void initializeStandardQuotas() {
    // Groq API Limits
    registerQuota(
        new QuotaDefinition("Groq", "Requests", 14400, QuotaPeriod.DAILY)); // 14.4k req/day
    ...
    registerQuota(
        new QuotaDefinition(
            "GCP", "CloudRun_Compute", 180000, QuotaPeriod.MONTHLY)); // vCPU-seconds
    registerQuota(
        new QuotaDefinition("GCP", "CloudFunctions_Invocations", 2000000, QuotaPeriod.MONTHLY));
  }
