 ...
 *
 * <p>Every command: - Has a unique name (e.g., "health-check", "refresh-github") - Can be sync or
 * async - Takes parameters and returns a result - Gets validated before execution - Gets logged for
 * audit trail
 */
public interface Command {

  /** Unique command identifier Examples: "health-check", "refresh-github", "optimize-quotas" */
  String getName();
  ...
  /** Validate parameters before execution Throws exception if invalid */
