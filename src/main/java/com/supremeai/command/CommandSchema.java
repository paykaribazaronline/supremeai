...
/** Schema for command parameters Defines what parameters a command accepts and validation rules */
  ...
  public void validate(Map<String, Object> params) {
    ...
    for (String required : requiredParams) {
      if (!params.containsKey(required)) {
        throw new CommandValidationException("Missing required parameter: " + required);
      }
    }
    ...
    for (Map.Entry<String, Object> entry : params.entrySet()) {
      ...
      if (!parameters.containsKey(name)) {
        throw new CommandValidationException("Unknown parameter: " + name);
      }
  ...
  public static class ParameterSpec {
    ...
    public void validate(Object value) {
      if (value == null && required) {
        throw new CommandValidationException(String.format("Parameter %s is required", name));
      }
