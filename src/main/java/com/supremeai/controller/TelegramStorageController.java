...
public class TelegramStorageController {
    ...
    public Mono<ResponseEntity<ApiResponse<Map<String, Object>>>> getBotStatus() {
        return telegramStorageService.checkBotStatus()
    ...
    public Mono<ResponseEntity<ApiResponse<String>>> triggerChatArchiving() {
        return chatArchiveService.archiveOldMessages()
    ...
    public Mono<ResponseEntity<ApiResponse<String>>> triggerLearningArchiving() {
        return learningArchiveService.archiveOldLearnings()
    ...
    public Mono<Map<String, Object>> deployTeldrive() {
        ...
        return Mono.just(Map.of("success", true, "message", "Teldrive deployment sequence initiated. Please ensure credentials are saved first."));
    }

    @GetMapping("/artifacts")
    public Mono<ResponseEntity<ApiResponse<java.util.List<com.supremeai.model.StorageMetadata>>>> listArtifacts() {
        return storageMetadataRepository.findAll()
    ...
    public Mono<ResponseEntity<ApiResponse<java.util.List<com.supremeai.model.StorageMetadata>>>> listLearningArchives() {
        return storageMetadataRepository.findAll()
                .filter(m -> "LEARNING_ARCHIVE".equals(m.getCategory()) || "LEARNING".equals(m.getCategory()))
                .collectList()
                .map(archives -> ResponseEntity.ok(ApiResponse.ok(archives)));
    }

    @GetMapping("/backups/codebase")
    public Mono<ResponseEntity<ApiResponse<java.util.List<com.supremeai.model.StorageMetadata>>>> listCodebaseBackups() {
        return storageMetadataRepository.findAll()
    ...
    public Mono<ResponseEntity<ApiResponse<java.util.List<com.supremeai.model.StorageMetadata>>>> getChatArchives(@PathVariable String userId) {
        return storageMetadataRepository.findAll()
    ...
    public Mono<ResponseEntity<ApiResponse<String>>> getDownloadUrl(@PathVariable String fileId) {
        return telegramStorageService.getDownloadUrl(fileId)
