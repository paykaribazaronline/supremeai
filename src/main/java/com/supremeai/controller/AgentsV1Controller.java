        ...
        .map(
            milestones -> {
              ...
              response.put(
                  "operationalCount",
                  milestones.stream()
                      .filter(m -> m.getProgress() != null && m.getProgress() == 100)
                      .count());
                  ...
                  milestones.stream()
                      .map(
                          m -> {
                            ...
                            phase.put(
                                "status",
                                m.getProgress() != null && m.getProgress() == 100
                                    ? "operational"
                                    : (m.getProgress() != null && m.getProgress() > 0
                                        ? "in-progress"
                                        : "pending"));
  ...
  public Mono<Map<String, Object>> getPhase8Summary() {
    return Mono.just(
        Map.of(
            ...
            3,
            "agents",
            List.of("SecurityAuditor", "VulnerabilityScanner", "PenTester"),
            "capabilities",
            List.of("Automated Pentesting", "Dependency Scanning", "Security Hardening")));
  }
  ...
  public Mono<Map<String, Object>> getPhase9Summary() {
    return Mono.just(
        Map.of(
            ...
            2,
            "agents",
            List.of("CostOptimizer", "QuotaManager"),
            "capabilities",
            List.of(
                "Cloud Bill Analysis",
                "Token Usage Optimization",
                "Multi-Provider Cost Balancing")));
  }
  ...
  public Mono<Map<String, Object>> getPhase10Summary() {
    return Mono.just(
        Map.of(
            ...
            List.of("SelfEvolver"),
            "capabilities",
            List.of("Recursive Improvement", "Heuristic Optimization")));
  }
  ...
  public Mono<Map<String, Object>> getPhase6Health() {
    return Mono.just(
        Map.of(
            ...
            4,
            "capabilities",
            List.of("External API Integration", "Webhook Orchestration", "Cross-Platform Sync")));
  }
