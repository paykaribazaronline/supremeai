...
/**
 * Controller for the system's autonomous cyber security skills. Handles self-audits, defensive
 * learning cycles, and protection status.
 */
@RestController
...
public class CyberSecurityController {
  ...
  @Autowired private CyberSecuritySkillService cyberSecuritySkillService;
  ...
  @PostMapping("/learn")
  public Mono<ResponseEntity<ApiResponse<Map<String, Object>>>> initiateLearning(
      @RequestBody Map<String, String> body) {
    String topic = body.getOrDefault("topic", "General Vulnerabilities");
    return cyberSecuritySkillService
        .initiateLearningCycle(topic)
  ...
  public Mono<ResponseEntity<ApiResponse<Map<String, Object>>>> getConfig() {
    return Mono.fromCallable(
        () -> {
          ...
          config.put(
              "autonomousLearningEnabled", cyberSecuritySkillService.isAutonomousLearningEnabled());
          config.put(
              "autonomousAuditEnabled", cyberSecuritySkillService.isAutonomousAuditEnabled());
  ...
  @PostMapping("/config")
  public Mono<ResponseEntity<ApiResponse<Map<String, Object>>>> updateConfig(
      @RequestBody Map<String, Boolean> body) {
    return Mono.fromCallable(
        () -> {
          if (body.containsKey("autonomousLearningEnabled")) {
            cyberSecuritySkillService.setAutonomousLearningEnabled(
                body.get("autonomousLearningEnabled"));
          }
