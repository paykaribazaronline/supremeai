...
public class CodeAnalysisController {
  ...
  @PostMapping("/analyze")
  public Mono<ResponseEntity<Map<String, Object>>> analyzeTestFailure(
      @RequestBody LogRequest request) {
    String prompt =
        "You are SupremeAI Code Analyzer. The following is a test failure log or error snippet from our CI/CD pipeline.\n"
    ...
    return votingService
        .executeEnsembleVoting(prompt, null, 20000L)
        .map(
            result -> {
