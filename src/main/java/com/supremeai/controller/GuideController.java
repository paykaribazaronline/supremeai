...
/**
 * Controller for user video guides/tutorials. Supports multiple languages (Bangla, English).
 *
 * <p>Endpoints: GET /api/guides - List all published guides GET /api/guides/{id} - Get a specific
 * guide GET /api/guides/category/{cat} - Get guides by category GET /api/guides/tag/{tag} - Get
 * guides by tag
 *
 * <p>Admin endpoints (protected by /api/admin/** pattern): POST /api/admin/guides - Create a new
 * guide PUT /api/admin/guides/{id} - Update a guide DELETE /api/admin/guides/{id} - Delete a guide
 */
@RestController
