...
/**
 * Learning Router Controller - Phase 4 (Plan 24) Exposes Q-learning router metrics and control
 * endpoints.
 */
@RestController
...
public class RouterController {
  ...
  @Autowired private SelfLearningRouter learningRouter;

  /** GET /api/admin/router/stats Get system-wide routing statistics. */
  @GetMapping("/stats")
  ...
  /** GET /api/admin/router/agent/{agentId} Get performance statistics for a specific agent. */
  ...
  /** GET /api/admin/router/agents Get statistics for all agents. */
  @GetMapping("/agents")
  public ResponseEntity<List<Map<String, Object>>> getAllAgentStats() {
    ...
    List<Map<String, Object>> agents =
        (List<Map<String, Object>>) allStats.getOrDefault("agentStats", List.of());

    return ResponseEntity.ok(agents);
  }

  /** POST /api/admin/router/reset Reset Q-learning table (for testing/re-training). */
  @PostMapping("/reset")
  ...
  /** GET /api/admin/router/q-table Get current Q-values for inspection (debugging). */
  @GetMapping("/q-table")
  ...
  /**
   * GET /api/admin/router/routing-decision Get routing decision for a specific task (debugging).
   */
