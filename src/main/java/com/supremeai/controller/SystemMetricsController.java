...
/**
 * System Metrics Controller - Phase 4 Provides system resource metrics for the monitoring
 * dashboard.
 */
@RestController
...
public class SystemMetricsController {
  ...
  /** GET /api/system/metrics/resources Get current system resource utilization. */
