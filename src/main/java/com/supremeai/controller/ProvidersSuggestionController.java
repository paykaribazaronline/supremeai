...
public class ProvidersSuggestionController {
  ...
  /**
   * Model suggestion DTO returned to the frontend. All data comes from Firestore api_providers at
   * runtime — no hardcoded defaults.
   */
  ...
  /**
   * Convert an APIProvider from Firestore cache into a ModelSuggestion. No values are hardcoded —
   * every field comes from the live metadata record.
   */
