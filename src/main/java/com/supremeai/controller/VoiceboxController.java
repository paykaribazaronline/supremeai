...
public class VoiceboxController {
  ...
  @Autowired private VoiceboxClientService voiceboxClientService;
  ...
  public Mono<ResponseEntity<Map>> transcribe(
      @RequestBody byte[] audioData, @RequestParam(required = false) String language) {
