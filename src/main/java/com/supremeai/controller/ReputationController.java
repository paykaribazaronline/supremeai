...
/**
 * Reputation Controller - Phase 4 (Plan 18) Exposes contributor reputation and trust scoring
 * endpoints.
 */
@RestController
...
public class ReputationController {
  ...
  /**
   * GET /api/admin/reputation/contributor/{contributorId} Get contributor profile with reputation
   * details.
   */
  ...
  /** GET /api/admin/reputation/top-contributors Get top contributors by category. */
  ...
  /** POST /api/admin/reputation/record-submission Record a submission result (accept/reject). */
  ...
  public ResponseEntity<Map<String, Object>> recordSubmission(
    ...
    if (contributorId == null) {
      return ResponseEntity.badRequest().body(Map.of("error", "contributorId is required"));
    }
  ...
  /** GET /api/admin/reputation/needs-review Get contributors requiring moderation. */
  ...
  /** POST /api/admin/reputation/calculate-quality Calculate quality score for an API submission. */
