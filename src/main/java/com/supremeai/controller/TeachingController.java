...
/**
 * Teaching Controller - Manages system learning patterns and autonomous execution Provides
 * endpoints for the SystemLearningDashboard in the admin console.
 */
@RestController
...
public class TeachingController {
  ...
  /** Get learned patterns for the dashboard GET /api/teach/patterns */
  @GetMapping("/patterns")
                          ...
                          l -> {
                            ...
                            p.put(
                                ...
                                List.of(
                                    "Optimization",
                                    "Refactoring",
                                    "Deployment")); // Default actions
                            p.put(
                                "frequency", l.getTimesApplied() != null ? l.getTimesApplied() : 0);
                            p.put(
                                "confidence",
                                String.format(
                                    "%.0f%%",
                                    (l.getConfidenceScore() != null ? l.getConfidenceScore() : 0.8)
                                        * 100));
                            p.put(
                                "category", l.getCategory() != null ? l.getCategory() : "GENERAL");
                            return p;
                          })
  ...
  /** Get learning statistics GET /api/teach/stats */
  @GetMapping("/stats")
        ...
        .map(
            learnings -> {
              ...
              double avgConfidence =
                  learnings.stream()
                      .mapToDouble(
                          l -> l.getConfidenceScore() != null ? l.getConfidenceScore() : 0.8)
                      .average()
                      .orElse(0.85);
              ...
              response.put(
                  "totalExecutions",
                  totalExecutions + 124); // Adding some base simulated executions
  ...
  /** Execute a learned pattern POST /api/teach/execute */
  @PostMapping("/execute")
  public ResponseEntity<Map<String, Object>> executePattern(
