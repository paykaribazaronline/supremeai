...
public class MCPMarketplaceController {
  ...
  public ResponseEntity<Map<String, Object>> approveSkill(@PathVariable String skillId) {
    ...
    if (success) {
      return ResponseEntity.ok(
          Map.of("success", true, "message", "স্কিলটি সফলভাবে অনুমোদিত হয়েছে (Approved)।"));
    }
    return ResponseEntity.badRequest()
        .body(Map.of("success", false, "message", "স্কিল অনুমোদন করতে ব্যর্থ হয়েছে।"));
  }
  ...
  public ResponseEntity<Map<String, Object>> rejectSkill(@PathVariable String skillId) {
    ...
    if (success) {
      return ResponseEntity.ok(
          Map.of("success", true, "message", "স্কিলটি বাতিল করা হয়েছে (Rejected)।"));
    }
    return ResponseEntity.badRequest()
        .body(Map.of("success", false, "message", "স্কিল বাতিল করতে ব্যর্থ হয়েছে।"));
  }
}
