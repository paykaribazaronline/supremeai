...
/**
 * Endpoint for Pub/Sub push subscriptions. Secure this endpoint in production using Pub/Sub
 * verification tokens or OIDC.
 */
@RestController
...
public class PubSubWebhookController {
  ...
  @Autowired private PubSubConsumerService consumerService;
