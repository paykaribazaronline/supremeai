...
public class VotingController {
  ...
  @Autowired private RequirementAnalyzerAI requirementAnalyzer;
  ...
  @PostMapping("/vote")
  public Mono<ResponseEntity<VotingDecision>> conductVote(
    ...
    return votingService.conductDecisionVote(question, context).map(ResponseEntity::ok);
  }
