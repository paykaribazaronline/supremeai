...
public class SoloModeHealthController {
    ...
    /**
     * GET /api/health/solo-mode
     * Returns whether the system is in solo mode — i.e. no active AI providers
     * are configured in Firestore and the system is running entirely on
    ...
    public ResponseEntity<Map<String, Object>> getSoloModeHealth() {
        ...
        if (inSoloMode) {
            ...
            health.put("message",
                "Active AI providers detected. System is operating in full AI mode.");
        }
