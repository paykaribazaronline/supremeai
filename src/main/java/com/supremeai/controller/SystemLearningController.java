...
/** System learning endpoints - ADMIN only. Stores AI system improvements and learnings. */
@RestController
...
public class SystemLearningController {
  ...
  public SystemLearningController(
      SystemLearningService service,
  ...
  public Flux<SystemLearning> getBestPractices(
      @PathVariable String category, @RequestParam(defaultValue = "0.8") double minQuality) {
  ...
  /**
   * Manually trigger a learning improvement cycle. Analyzes collected patterns, optimizes knowledge
   * base, and generates improvements. ADMIN only endpoint for system maintenance.
   */
  ...
  /**
   * System learning improvement endpoint for CLI and automation. Collects error data, analyzes
   * patterns, and updates knowledge base. More comprehensive than trigger-improvement with detailed
   * reporting.
   */
  @PostMapping("/improve")
  ...
  /**
   * Trigger autonomous research on a specific cybersecurity topic. System learns hacking techniques
