...
/**
 * n8n অটোমেশন কন্ট্রোলার। এটি ড্যাশবোর্ড বা এক্সটার্নাল এপিআই থেকে n8n ইন্টিগ্রেশন এবং ফ্লো ট্রিগার
 * করার সুবিধা দেয়।
 */
@RestController
...
public class N8nController {
  ...
  @Autowired private N8nIntegrationService n8nService;
        ...
        .map(
            connected ->
                Map.<String, Object>of(
                    ...
                    "message",
                    connected
                        ? "n8n সার্ভিসের সাথে সফলভাবে সংযোগ স্থাপিত হয়েছে।"
                        : "n8n সার্ভিসের সাথে সংযোগ করা যায়নি।"));
  }
        ...
        .map(
            response ->
                Map.<String, Object>of(
                    ...
                    true,
                    "message",
                    "ওয়েবহুক সফলভাবে ট্রিগার হয়েছে।",
                    "response",
                    response))
        .onErrorResume(
            e -> Mono.just(Map.<String, Object>of("success", false, "error", e.getMessage())));
  }
