...
/** Metrics service for real-time monitoring. Integrates with Prometheus for metrics collection. */
@Service
public class MetricsService {
  ...
  public MetricsService(MeterRegistry meterRegistry) {
    ...
    this.requestCounter =
        Counter.builder("supremeai.requests.total")
            .description("Total number of requests")
            .register(meterRegistry);

    this.errorCounter =
        Counter.builder("supremeai.errors.total")
            .description("Total number of errors")
            .register(meterRegistry);

    this.circuitBreakerTrips =
        Counter.builder("supremeai.circuitbreaker.trips")
            .description("Number of circuit breaker trips")
            .register(meterRegistry);

    this.requestTimer =
        Timer.builder("supremeai.request.duration")
  ...
  public <T> CompletableFuture<T> timeAsyncRequest(
      String provider, Supplier<CompletableFuture<T>> request) {
