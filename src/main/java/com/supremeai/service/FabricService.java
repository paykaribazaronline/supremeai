...
/**
 * FabricService manages and provides access to human-curated AI logic patterns. These patterns can
 * be used to guide LLMs for specific tasks like code review, summarization, or security auditing,
  ...
  public Mono<String> getPattern(String patternName) {
    ...
    return Mono.just(
        "You are an expert "
            ...
            + ". Your task is to provide a concise and actionable response based on the following input:");
  }
}
