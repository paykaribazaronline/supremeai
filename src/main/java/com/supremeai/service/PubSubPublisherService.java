...
/**
 * Google Cloud Pub/Sub publisher using low-level client. Publishes reverse engineering jobs to a
 * Pub/Sub topic.
 */
@Service
public class PubSubPublisherService {
  ...
  public void publish(String topicName, Map<String, Object> payload) {
    ...
    try {
      ...
      logger.info(
          "Published message {} to topic {}: jobId={}", messageId, topicName, payload.get("jobId"));
    } catch (Exception e) {
