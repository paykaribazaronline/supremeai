...
public class BrowserService {
  ...
  // Circuit Breaker স্ক্র্যাপিং অপারেশনের জন্য - সিস্টেমকে টলেরপোর্টেড করে
  // যদি ব্রাউজার দুর্বল হয়, তাহলে স্বয়ংক্রিয়ভাবে ফেলোভার চালু হবে
  @CircuitBreaker(name = "browser-service", fallbackMethod = "scrapeFallback")
  @Retry(name = "browser-service")
  @TimeLimiter(name = "browser-service")
