  ...
  public ClassificationResult classify(String message) {
    ...
    if (maxScore < confidenceThreshold) {
      return new ClassificationResult(
          ChatType.NORMAL, 1.0 - maxScore, "এটি একটি সাধারণ চ্যাট মেসেজ");
    }

    if (maxScore == ruleScore) {
      return new ClassificationResult(
          ChatType.RULE, ruleScore, "এই মেসেজে রুলস বা নিয়মাবলী রয়েছে");
    } else if (maxScore == planScore) {
      return new ClassificationResult(
          ChatType.PLAN, planScore, "এই মেসেজে পরিকল্পনা বা প্ল্যান রয়েছে");
    } else if (maxScore == adminScore) {
      return new ClassificationResult(
          ChatType.ADMIN_ACTION,
          adminScore,
          "এই মেসেজে প্রশাসনিক নির্দেশ বা অ্যাডমিন অ্যাকশন রয়েছে");
    } else {
      return new ClassificationResult(
          ChatType.COMMAND, commandScore, "এই মেসেজে কমান্ড বা নির্দেশ রয়েছে");
    }
  }
