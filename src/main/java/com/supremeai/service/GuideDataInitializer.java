...
/**
 * Data initializer for sample video tutorials. Populates Firestore with Bangla and English guides
 * on first startup.
 */
@Component
public class GuideDataInitializer {
  ...
  @Autowired private UserGuideRepository userGuideRepository;
  ...
  public void initialize() {
    ...
    userGuideRepository
        ...
        .subscribe(
            ...
            error ->
                log.error("[GUIDE] Failed to initialize sample guides: {}", error.getMessage()),
  ...
  private Flux<UserGuide> createSampleGuides() {
    ...
    gettingStartedEn.setTitle(
        Map.of(
            "en", "Getting Started with SupremeAI",
            "bn", "সুপ্রিমএআই-এ শুরু করা"));
    gettingStartedEn.setDescription(
        Map.of(
            "en",
                "Learn the basics of SupremeAI: how to log in, navigate the dashboard, and create your first AI-powered Android app.",
            "bn",
                "সুপ্রিমএআই-এর বেরকম: কীভাবে লগইন করবেন, ড্যাশবোর্ডে নেভিগেট করবেন এবং আপনার প্রথম এআই-চালিত অ্যান্ড্রয়েড অ্যাপ তৈরি করবেন।"));
    gettingStartedEn.setVideoUrl(
        Map.of(
    ...
    firebaseAuthEn.setTitle(
        Map.of(
            "en", "Firebase Authentication Setup",
            "bn", "ফায়ারবেস অথেন্টিকেশন সেটআপ"));
    firebaseAuthEn.setDescription(
        Map.of(
            "en",
                "Step-by-step guide to set up Firebase Authentication for your SupremeAI instance. Learn about security rules and user management.",
            "bn",
                "আপনার সুপ্রিমএআই ইনস্ট্যান্সের জন্য ফায়ারবেস অথেন্টিকেশন সেটআপের ধাপে ধাপে গাইড। সিকিউরিটি রুলস এবং ইউজার ম্যানেজমেন্ট সম্পর্কে শিখুন।"));
    firebaseAuthEn.setVideoUrl(
        Map.of(
    ...
    apiKeysEn.setDescription(
        Map.of(
            "en",
                "How to add, update, and secure your API keys for different AI providers (OpenAI, Anthropic, Groq, etc.). Learn about key rotation and monitoring.",
            "bn",
                "বিভিন্ন এআই প্রোভাইডার (OpenAI, Anthropic, Groq, ইত্যাদি)-এর জন্য আপনার API কী কীভাবে যোগ, আপডেট এবং নিরাপদ রাখবেন। কী রোটেশন এবং মনিটরিং সম্পর্কে শিখুন।"));
    apiKeysEn.setVideoUrl(
        Map.of(
    ...
    projectsEn.setDescription(
        Map.of(
            "en",
                "Learn how to create new app projects, track their progress, and manage project settings in SupremeAI.",
            "bn",
                "সুপ্রিমএআই-এ নতুন অ্যাপ প্রজেক্ট কীভাবে তৈরি করবেন, তাদের অগ্রগতি ট্র্যাক করবেন এবং প্রজেক্ট সেটিংস ম্যানেজ করবেন তা শিখুন।"));
    projectsEn.setVideoUrl(
        Map.of(
    ...
    adminGuideEn.setTitle(
        Map.of(
            "en", "Admin Dashboard Overview",
            "bn", "অ্যাডমিন ড্যাশবোর্ড ওভারভিউ"));
    adminGuideEn.setDescription(
        Map.of(
            "en",
                "Comprehensive overview of the admin dashboard: monitoring system health, managing users, and configuring system settings.",
            "bn",
                "অ্যাডমিন ড্যাশবোর্ডের সম্পূর্ণ ওভারভিউ: সিস্টেম হেল्थ মনিটরিং, ব্যবহারকারী ব্যবস্থাপনা এবং সিস্টেম কনফিগারেশন।"));
    adminGuideEn.setVideoUrl(
        Map.of(
