...
/**
 * Cache invalidation service for multi-tier caching strategy. Handles automatic and manual cache
 * invalidation with event-driven updates.
 */
@Service
public class CacheInvalidationService {
  ...
  public CacheInvalidationService(
    ...
    this.invalidationTimer =
        Timer.builder("cache.invalidation.duration")
