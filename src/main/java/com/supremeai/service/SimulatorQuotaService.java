...
public class SimulatorQuotaService {
  ...
  /**
   * Validates that the user can install a new app. Throws if quota exceeded or app already
   * installed.
   */
  ...
  /**
   * Validates that a session can be launched for the given app. Throws if app not installed or
