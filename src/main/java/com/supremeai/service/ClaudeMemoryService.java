...
/**
 * ClaudeMemoryService provides long-term context and memory for AI agents. It interfaces with
 * Claude-mem/Mem0 or a custom MCP server.
 */
@Service
public class ClaudeMemoryService {
  ...
  public ClaudeMemoryService(
      ...
      @Value("${supremeai.claude-mem.url:http://localhost:3000}") String baseUrl) {
