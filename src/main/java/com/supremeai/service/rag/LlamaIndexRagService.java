...
public class LlamaIndexRagService {
  ...
  public String ingestDocument(String indexName, String text, Map<String, Object> metadata)
      throws IOException {
    if (llamaindexApiKey == null
        || llamaindexApiKey.isBlank()
        || llamaindexApiUrl == null
        || llamaindexApiUrl.isBlank()) {
  ...
  public List<Map<String, Object>> queryIndex(String indexName, String query, int topK)
      throws IOException {
    if (llamaindexApiKey == null
        || llamaindexApiKey.isBlank()
        || llamaindexApiUrl == null
