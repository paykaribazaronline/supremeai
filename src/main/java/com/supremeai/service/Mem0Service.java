...
/**
 * Mem0Service provides personalized long-term memory for AI agents. It interfaces with the Mem0 API
 * to store and retrieve user-specific preferences and context.
 */
@Service
public class Mem0Service {
  ...
  public Mem0Service(
      ...
      @Value("${supremeai.mem0.url:http://localhost:8000}") String baseUrl) {
