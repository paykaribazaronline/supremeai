...
/**
 * Service for dynamically managing and providing instructions to AI agents. Rules are fetched from
 * Firestore with a file-based fallback (AGENTS.md).
 */
@Service
public class DynamicInstructionService {
  ...
  @Autowired private SystemInstructionRepository instructionRepository;
  ...
  public Mono<String> getCombinedInstructions(String taskType) {
    return instructionRepository
        .findAllByIsActiveOrderByPriorityDesc(true)
        .filter(
            ins ->
                ins.getApplicableTaskTypes() == null
