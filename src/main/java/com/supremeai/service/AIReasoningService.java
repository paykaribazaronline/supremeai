...
public class AIReasoningService {
  ...
  @org.springframework.beans.factory.annotation.Autowired private ConfigService configService;
  ...
  public Mono<Void> logReasoningAsync(
      String taskId, String decision, String reason, String modelName) {
