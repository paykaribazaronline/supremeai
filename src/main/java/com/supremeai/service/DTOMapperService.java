...
/**
 * Service for mapping entities to DTOs. Optimizes data transfer by only including necessary fields.
 */
@Service
public class DTOMapperService {
  ...
  public List<UserApiKeyDTO> toUserApiKeyDTOList(List<UserApiKey> apiKeys) {
    ...
    return apiKeys.stream().map(this::toUserApiKeyDTO).collect(Collectors.toList());
  }
