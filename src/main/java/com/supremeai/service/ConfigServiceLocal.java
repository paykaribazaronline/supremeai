...
/**
 * Local ConfigService for local development profile.
 * Provides configuration management without Firestore dependency.
 * This service is used when running with the "local" profile.
 */
@Profile("local")
@Service
