...
public class AIBehaviorProfileService {
  ...
  @Autowired private AIBehaviorProfileRepository profileRepository;
  ...
  public Mono<AIBehaviorProfile> saveProfile(AIBehaviorProfile profile) {
    ...
    return profileRepository
        ...
        .doOnSuccess(
            saved ->
                logger.info("Saved AI behavior profile for project: {}", saved.getProjectId()));
  }
  ...
  public Mono<AIBehaviorProfile> getDefaultProfile() {
    ...
    defaultProfile.setAdditionalPreferences(
        Map.of(
            "includeTests", true,
            "includeDocker", true,
            "javaVersion", "17"));
  ...
  public void applyProfileToContext(
      AIBehaviorProfile profile, Map<String, Object> generationContext) {
    ...
    logger.info(
        "Applied behavior profile to generation context for project: {}", profile.getProjectId());
  }
