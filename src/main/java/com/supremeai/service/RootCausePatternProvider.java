  ...
  public Map<String, RootCausePattern> providePatterns() {
    ...
    rootCausePatterns.put(
        ...
        new RootCausePattern(
            ...
            Pattern.compile(
                "(?i)jwt|token.*expired|invalid.*token|401|JwtException|SignatureException"),
            CorrectionAction.MANUAL_REVIEW,
            0.90));
    ...
    rootCausePatterns.put(
        ...
        new RootCausePattern(
            ...
            Pattern.compile(
                "BeanCreationException|UnsatisfiedDependencyException|Error creating bean"),
            CorrectionAction.MANUAL_REVIEW,
            0.93));
    ...
    rootCausePatterns.put(
        ...
        new RootCausePattern(
            ...
            Pattern.compile(
                "JsonParseException|MismatchedInputException|InvalidDefinitionException|cannot deserialize"),
            CorrectionAction.MANUAL_REVIEW,
            0.89));
    ...
    rootCausePatterns.put(
        ...
        new RootCausePattern(
            ...
            Pattern.compile(
                "Could not resolve placeholder|property.*not found|Missing environment variable"),
            CorrectionAction.MANUAL_REVIEW,
            0.92));
