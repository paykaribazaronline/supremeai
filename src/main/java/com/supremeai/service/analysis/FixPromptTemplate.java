...
public class FixPromptTemplate {
  ...
  public static class FixPromptTemplateBuilder {
    ...
    public FixPromptTemplateBuilder templateName(String templateName) {
      this.templateName = templateName;
      return this;
    }

    public FixPromptTemplateBuilder template(String template) {
      this.template = template;
      return this;
    }

    public FixPromptTemplateBuilder outputFormat(String outputFormat) {
      this.outputFormat = outputFormat;
      return this;
    }
  ...
  public static class FixContext {
    ...
    public static class FixContextBuilder {
      ...
      public FixContextBuilder filePath(String filePath) {
        this.filePath = filePath;
        return this;
      }

      public FixContextBuilder lineNumber(int lineNumber) {
        this.lineNumber = lineNumber;
        return this;
      }

      public FixContextBuilder findingMessage(String findingMessage) {
        this.findingMessage = findingMessage;
        return this;
      }

      public FixContextBuilder suggestion(String suggestion) {
        this.suggestion = suggestion;
        return this;
      }

      public FixContextBuilder codeSnippet(String codeSnippet) {
        this.codeSnippet = codeSnippet;
        return this;
      }

      public FixContextBuilder severity(String severity) {
        this.severity = severity;
        return this;
      }

      public FixContextBuilder category(String category) {
        this.category = category;
        return this;
      }

      public FixContextBuilder language(String language) {
        this.language = language;
        return this;
      }
