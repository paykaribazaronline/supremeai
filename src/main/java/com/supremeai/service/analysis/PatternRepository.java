...
/**
 * Repository for security pattern rules (OWASP based). In Phase 1, patterns are
 * hardcoded. Later
...
public class PatternRepository {
    ...
    public PatternRepository() {
        ...
        log.info("Initialized PatternRepository. Knowledge externalization complete - hardcoded rules removed.");
    }
