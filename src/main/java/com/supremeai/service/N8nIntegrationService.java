...
/**
 * n8n অটোমেশন হাব ইন্টিগ্রেশন সার্ভিস। এটি SupremeAI ব্যাকএন্ড থেকে n8n ফ্লো এবং এপিআই ট্রিগার করতে
 * ব্যবহৃত হয়।
 */
@Service
public class N8nIntegrationService {
  ...
  public N8nIntegrationService(
      @Value("${n8n.url:}") String n8nUrl, @Value("${n8n.api.key:}") String apiKey) {
    this.n8nUrl = n8nUrl;
    this.apiKey = apiKey;
  ...
  public Mono<String> triggerWebhook(String webhookPath, Map<String, Object> payload) {
    ...
    return webClient
        ...
        .doOnError(
            error -> logger.error("[n8n] ওয়েবহুক ট্রিগার ব্যর্থ হয়েছে: {}", error.getMessage()));
  }
