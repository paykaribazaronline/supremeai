...
public class KnowledgeRetrievalService {
  ...
  /**
   * Searches the system's learned knowledge for relevant entries based on a query. This can be used
   * by AI agents to access local knowledge.
   *
  ...
  public Flux<SystemLearning> searchLocalKnowledge(String query) {
    ...
    return systemLearningRepository
        ...
        .filter(
            sl ->
                sl.getTitle().toLowerCase().contains(lowerCaseQuery)
