...
/**
 * Repository for ProviderTaskPerformance Firestore collection.
 * Collection: provider_task_performance
 * Mapped from: M-07 / DATABASE_LINKAGE_MAP.md
 */
@Repository
public interface ProviderTaskPerformanceRepository extends ReactiveCrudRepository<ProviderTaskPerformance, String> {
