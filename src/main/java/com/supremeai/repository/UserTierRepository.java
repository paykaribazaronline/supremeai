...
/**
 * Repository for UserTierConfig Firestore collection. Collection: user_tiers (one document per
 * tier, keyed by UserTier enum name) Mapped from: M-02 / DATABASE_LINKAGE_MAP.md
 */
@Repository
