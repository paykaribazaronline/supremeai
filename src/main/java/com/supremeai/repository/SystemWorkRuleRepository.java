...
/**
 * Repository for system_work_rules collection in Firestore.
 * The admin panel reads from and writes to this collection to define
 * authoritative rules for how the system carries out work in production.
 */
@Repository
