...
public class ClarificationResponse {
  ...
  // Builder pattern
  public static ClarificationResponse builder() {
    return new ClarificationResponse();
  }

  public ClarificationResponse needsClarification(boolean needsClarification) {
    this.needsClarification = needsClarification;
    return this;
  }

  public ClarificationResponse questions(List<String> questions) {
    this.questions = questions;
    return this;
  }

  public ClarificationResponse suggestedApproach(String suggestedApproach) {
    this.suggestedApproach = suggestedApproach;
    return this;
  }

  public ClarificationResponse directResponse(String directResponse) {
    this.directResponse = directResponse;
    return this;
  }

  public ClarificationResponse build() {
    return this;
  }
}
