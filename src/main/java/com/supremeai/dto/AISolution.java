...
public class AISolution {
    ...
    public AISolution(String providerId, String solutionContent, String generatedCode, double selfScore) {
    ...
    public double evaluate(AISolution other) {
        if (other == null || other.getSolutionContent() == null || this.solutionContent == null) return 0.0;
