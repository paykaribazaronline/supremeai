...
/**
 * Data Transfer Object for UserApiKey. Used to avoid exposing sensitive API key data and optimize
 * query performance.
 */
public class UserApiKeyDTO {
  ...
  public LocalDateTime getRotationDueAt() {
    return rotationDueAt;
  }

  public void setRotationDueAt(LocalDateTime rotationDueAt) {
  ...
  public void setNeedsRotation(boolean needsRotation) {
    this.needsRotation = needsRotation;
  }
}
