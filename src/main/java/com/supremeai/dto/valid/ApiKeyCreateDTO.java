...
public class ApiKeyCreateDTO {
    ...
    @Pattern(regexp = "^(https?://)?[a-zA-Z0-9.-]+(:[0-9]+)?(/.*)?$", message = "Invalid base URL format")
    private String baseUrl;

    private List<@Size(max = 100, message = "Model name must not exceed 100 characters") String> models;

    public ApiKeyCreateDTO() {
    }

    public ApiKeyCreateDTO(String provider, String label, String apiKey, String baseUrl, List<String> models) {
