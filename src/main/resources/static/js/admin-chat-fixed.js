// Admin Chat Management JavaScript - Fixed version (copied from admin-chat.js)
...
class AdminChatManager {
    ...
    async loadChatHistory(filter = 'all') {
        try {
            ...
            this.allItems.history = fetchedHistory;
...
// AdminChatManager initialization is now managed by initPlatform() in admin.html
