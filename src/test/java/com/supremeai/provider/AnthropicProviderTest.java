...
class AnthropicProviderTest {
  ...
  void setUp() throws IOException {
    ...
    try {
      java.lang.reflect.Field field =
          AnthropicProvider.class.getSuperclass().getDeclaredField("baseUrl");
  ...
  void getCapabilities_shouldIncludeClaudeModels() {
    ...
    java.util.List<String> models =
        (modelsObj instanceof java.util.List)
  ...
  void createRequestBody_shouldContainMessagesModelAndMaxTokens() throws Exception {
    java.lang.reflect.Method method =
        AnthropicProvider.class.getDeclaredMethod("createRequestBody", String.class);
  ...
  void extractResponse_shouldParseValidResponse() throws Exception {
    String jsonResponse =
        objectMapper.writeValueAsString(
            Map.of("content", java.util.List.of(Map.of("text", "Hello from Claude!"))));

    java.lang.reflect.Method method =
        AnthropicProvider.class.getDeclaredMethod("extractResponse", String.class);
    method.setAccessible(true);
  ...
  void httpIntegration_shouldReturnGeneratedText() throws Exception {
    String responseBody =
        objectMapper.writeValueAsString(
            Map.of("content", java.util.List.of(Map.of("text", "Mocked Anthropic response"))));
