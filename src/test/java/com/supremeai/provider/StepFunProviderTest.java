...
class StepFunProviderTest {
  ...
  void setUp() throws IOException {
    ...
    try {
      java.lang.reflect.Field field =
          StepFunProvider.class.getSuperclass().getDeclaredField("baseUrl");
  ...
  void createRequestBody_shouldUseDefaultFlashModel() throws Exception {
    java.lang.reflect.Method method =
        StepFunProvider.class.getDeclaredMethod("createRequestBody", String.class);
  ...
  void extractResponse_shouldParseValidResponse() throws Exception {
    String jsonResponse =
        objectMapper.writeValueAsString(
            Map.of(
                "choices",
                java.util.List.of(Map.of("message", Map.of("content", "Hello from StepFun!")))));

    java.lang.reflect.Method method =
        StepFunProvider.class.getDeclaredMethod("extractResponse", String.class);
    method.setAccessible(true);
