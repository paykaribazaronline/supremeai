...
class StubLocalProviderTest {
    ...
    void testInitLoadsKnowledgeBase() {
        ...
        assertTrue(topicCount > 0, "Knowledge base should not be empty after init. Check core_knowledge.json.");
    }
    ...
    void testGenerateRealResponseFactual() {
        ...
        assertTrue(response.toLowerCase().contains("flutter") || response.toLowerCase().contains("ui toolkit"));
    }
