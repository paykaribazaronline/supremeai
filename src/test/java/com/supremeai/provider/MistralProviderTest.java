...
class MistralProviderTest {MockWebServerpublic MistralProviderTest(MockWebServer mockWebServer, MistralProvider provider, ObjectMapper objectMapper) {
...
MockWebServer}
    ...
    void setUp() throws IOException {
        ...
        try {
            java.lang.reflect.Field field = MistralProvider.class.getSuperclass().getDeclaredField("baseUrl");
    ...
    void createRequestBody_shouldUseLatestModel() throws Exception {
        java.lang.reflect.Method method = MistralProvider.class.getDeclaredMethod("createRequestBody", String.class);
    ...
    void extractResponse_shouldParseValidResponse() throws Exception {
        String jsonResponse = objectMapper.writeValueAsString(Map.of(
                "choices", java.util.List.of(
                        Map.of("message", Map.of("content", "Hello from Mistral!"))
                )
        ));

        java.lang.reflect.Method method = MistralProvider.class.getDeclaredMethod("extractResponse", String.class);
        method.setAccessible(true);
