...
class CodeGeeX4ProviderEnhancedTest {
  ...
  void setUp() throws IOException {
    ...
    try {
      java.lang.reflect.Field field =
          CodeGeeX4Provider.class.getSuperclass().getDeclaredField("baseUrl");
  ...
  void createRequestBody_shouldIncludeSystemMessage() throws Exception {
    java.lang.reflect.Method method =
        CodeGeeX4Provider.class.getDeclaredMethod("createRequestBody", String.class);
    ...
    java.util.List<Map<String, Object>> messages =
        (java.util.List<Map<String, Object>>) body.get("messages");
  ...
  void extractResponse_shouldParseValidResponse() throws Exception {
    String jsonResponse =
        objectMapper.writeValueAsString(
            Map.of(
                "choices",
                java.util.List.of(Map.of("message", Map.of("content", "Hello from CodeGeeX4!")))));

    java.lang.reflect.Method method =
        CodeGeeX4Provider.class.getDeclaredMethod("extractResponse", String.class);
    method.setAccessible(true);
  ...
  void extractResponse_shouldThrowOnErrorResponse() throws Exception {
    String jsonResponse = objectMapper.writeValueAsString(Map.of("error", "Invalid API key"));
    ...
    Exception exception =
        assertThrows(Exception.class, () -> method.invoke(provider, jsonResponse));
  ...
  void extractResponse_shouldHandleNullContent() throws Exception {
    ...
    String jsonResponse =
        objectMapper.writeValueAsString(
            Map.of("choices", java.util.List.of(Map.of("message", messageMap))));
