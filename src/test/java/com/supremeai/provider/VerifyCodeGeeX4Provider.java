  ...
  public static void main(String[] args) {
    try {
      ...
      if ("codegeex4".equals(name)) {
        ...
        System.out.println(
            "✗ Test 2 FAILED: getName() returned '" + name + "' instead of 'codegeex4'");
        System.exit(1);
      }
      ...
      if (capabilities != null && capabilities.containsKey("name")) {
        System.out.println(
            "✓ Test 3 PASSED: getCapabilities() returns non-null map with 'name' key");
        ...
        System.out.println(
            "✗ Test 3 FAILED: getCapabilities() returned null or missing 'name' key");
        System.exit(1);
      }
      ...
      if (superClass != null && superClass.getSimpleName().equals("AbstractHttpProvider")) {
        ...
        System.out.println(
            "✗ Test 4 FAILED: CodeGeeX4Provider does not extend AbstractHttpProvider");
        System.exit(1);
      }
