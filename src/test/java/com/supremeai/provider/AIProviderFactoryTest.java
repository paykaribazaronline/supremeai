...
/**
 * Unit tests for AIProviderFactory. Tests provider creation, key resolution, and error handling.
 */
class AIProviderFactoryTest {
  ...
  void setUp() throws Exception {
    ...
    APIProvider huggingfaceMeta =
        new APIProvider("huggingface", "huggingface", "huggingface", "active");
    ...
    java.lang.reflect.Field metaField =
        AIProviderFactory.class.getDeclaredField("providerMetadataService");
    metaField.setAccessible(true);
    metaField.set(factory, mockMetadataService);

    StubLocalProvider stubLocalProvider = new StubLocalProvider();
    java.lang.reflect.Field stubField =
        AIProviderFactory.class.getDeclaredField("stubLocalProvider");
