...
class KimiProviderTest {
  ...
  void setUp() throws IOException {
    ...
    try {
      java.lang.reflect.Field field =
          KimiProvider.class.getSuperclass().getDeclaredField("baseUrl");
  ...
  void createRequestBody_shouldUse128kModel() throws Exception {
    java.lang.reflect.Method method =
        KimiProvider.class.getDeclaredMethod("createRequestBody", String.class);
  ...
  void extractResponse_shouldParseValidResponse() throws Exception {
    String jsonResponse =
        objectMapper.writeValueAsString(
            Map.of(
                "choices",
                java.util.List.of(Map.of("message", Map.of("content", "Hello from Kimi!")))));

    java.lang.reflect.Method method =
        KimiProvider.class.getDeclaredMethod("extractResponse", String.class);
    method.setAccessible(true);
  ...
  void httpIntegration_shouldReturnGeneratedText() throws Exception {
    String responseBody =
        objectMapper.writeValueAsString(
            Map.of(
                "choices",
                java.util.List.of(Map.of("message", Map.of("content", "Mocked Kimi response")))));
