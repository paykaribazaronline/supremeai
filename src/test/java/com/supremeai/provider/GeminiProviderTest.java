...
class GeminiProviderTest {
  ...
  void setUp() throws IOException {
    ...
    mockWebServer.start();
    String baseUrl =
        mockWebServer.url("/v1beta/models/gemini-1.5-flash:generateContent").toString();
    provider = new GeminiProvider("AIzaSy-test-key");
    try {
      java.lang.reflect.Field field =
          GeminiProvider.class.getSuperclass().getDeclaredField("baseUrl");
  ...
  void createRequestBody_shouldUseGeminiFormat() throws Exception {
    java.lang.reflect.Method method =
        GeminiProvider.class.getDeclaredMethod("createRequestBody", String.class);
  ...
  void createRequestBody_shouldWrapPromptInParts() throws Exception {
    ...
    java.util.List<Map<String, Object>> contents =
        (java.util.List<Map<String, Object>>) body.get("contents");
    assertEquals(1, contents.size());
    @SuppressWarnings("unchecked")
    java.util.List<Map<String, Object>> parts =
        (java.util.List<Map<String, Object>>) contents.get(0).get("parts");
  ...
  void extractResponse_shouldParseValidResponse() throws Exception {
    ...
    java.lang.reflect.Method method =
        GeminiProvider.class.getDeclaredMethod("extractResponse", String.class);
    method.setAccessible(true);
  ...
  void extractResponse_shouldReturnDefault_whenNoCandidates() throws Exception {
    String jsonResponse =
        objectMapper.writeValueAsString(Map.of("candidates", java.util.List.of()));
  ...
  void extractResponse_shouldReturnDefault_whenContentNull() throws Exception {
    ...
    String jsonResponse =
        objectMapper.writeValueAsString(Map.of("candidates", java.util.List.of(contentMap)));
  ...
  void extractResponse_shouldReturnDefault_whenPartsEmpty() throws Exception {
    String jsonResponse =
        objectMapper.writeValueAsString(
            Map.of(
                "candidates",
                java.util.List.of(Map.of("content", Map.of("parts", java.util.List.of())))));
            ...
            Map.of(
                ...
                java.util.List.of(
                    Map.of(
                        ...
                        Map.of(
                            "parts",
                            java.util.List.of(Map.of("text", "Mocked Gemini response")))))));
