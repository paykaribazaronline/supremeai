...
/** Unit tests for EvolutionPersistence. Tests saving and loading best agent configurations. */
class EvolutionPersistenceTest {
  ...
  void testSaveBestConfig_invalidDirectory_handlesGracefully() {
    ...
    TestableEvolutionPersistence badPersistence =
        new TestableEvolutionPersistence("/invalid/path/config.properties") {
          @Override
