...
/**
 * Unit tests for LearningActivityLogService.
 * Tests logging methods produce expected behavior without exceptions.
 */
class LearningActivityLogServiceTest {
    ...
    void testLogSiteAccess_grantedLogsInfo() {
        LearningActivityLogService service = new LearningActivityLogService();
        // Should not throw
        assertDoesNotThrow(() -> service.logSiteAccess("https://example.com", true, "allowed", "admin"));
    }

    @Test
    void testLogSiteAccess_deniedLogsWarn() {
        LearningActivityLogService service = new LearningActivityLogService();
        assertDoesNotThrow(() -> service.logSiteAccess("https://blocked.com", false, "denied", "admin"));
    }
