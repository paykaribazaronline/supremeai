...
/**
 * Unit tests for EnhancedWebScraperService. Tests rate limiting, deduplication, content extraction,
 * and quality scoring.
 */
class EnhancedWebScraperServiceTest {
  ...
  void setUp() {
    ...
    try {
      java.lang.reflect.Field fieldSanitizer =
          EnhancedWebScraperService.class.getDeclaredField("sanitizer");
    ...
    try {
      java.lang.reflect.Field fieldConfig =
          EnhancedWebScraperService.class.getDeclaredField("configService");
  ...
  void testCalculateQualityScore_mediumLengthWithCode_addsPoints() {
    String content =
        "This is a decent length article about programming. Here's some code:\n"
  ...
  void testConvertToSolution_sanitizerRejects_returnsNull() {
    Object scraped =
        createScrapedContent(
            "https://example.com/bad", "Bad", "bad", "bad", "example.com", 0.3, Set.of(), 0.2);
  ...
  private Set<String> invokeDetectTechnologies(String content) {
    try {
      var method =
          EnhancedWebScraperService.class.getDeclaredMethod("detectTechnologies", String.class);
      method.setAccessible(true);
  ...
  private long invokeEstimateExecutionTime(String code) {
    try {
      var method =
          EnhancedWebScraperService.class.getDeclaredMethod("estimateExecutionTime", String.class);
      method.setAccessible(true);
  ...
  private double invokeEstimateSecurityScore(String code) {
    try {
      var method =
          EnhancedWebScraperService.class.getDeclaredMethod("estimateSecurityScore", String.class);
      method.setAccessible(true);
  ...
  private boolean invokeCheckRateLimit(String url) {
    try {
      var method =
          EnhancedWebScraperService.class.getDeclaredMethod("checkRateLimit", String.class);
      method.setAccessible(true);
  ...
  private double invokeCalculateQualityScore(String content, String code, Set<String> tech) {
    try {
      var method =
          EnhancedWebScraperService.class.getDeclaredMethod(
              "calculateQualityScore", String.class, String.class, Set.class);
      method.setAccessible(true);
  ...
  private Object createScrapedContent(
      String url,
      String title,
      String content,
      String code,
    ...
    try {
      var ctor =
          EnhancedWebScraperService.ScrapedContent.class.getDeclaredConstructor(
              String.class,
              String.class,
              String.class,
              String.class,
  ...
  private Object invokeConvertToSolution(Object scraped, String errorSignature) {
    try {
      var method =
          EnhancedWebScraperService.class.getDeclaredMethod(
              "convertToSolution", EnhancedWebScraperService.ScrapedContent.class, String.class);
      method.setAccessible(true);
