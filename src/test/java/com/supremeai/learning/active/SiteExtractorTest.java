...
/**
 * Unit tests for SiteExtractor interface.
 * Tests default method behaviors.
 */
class SiteExtractorTest {

    @Test
    void testDefaultIsEnabled_returnsTrue() {
        SiteExtractor extractor = new SiteExtractor() {
            @Override
            public String getSourceName() { return "test"; }
            @Override
            public String getDescription() { return "test"; }
            @Override
            public double getAuthorityWeight() { return 0.5; }
            @Override
            public java.util.List<ActiveInternetScraper.ScrapedIssue> scrape(org.springframework.web.client.RestTemplate restTemplate, int limit, Object... context) {
