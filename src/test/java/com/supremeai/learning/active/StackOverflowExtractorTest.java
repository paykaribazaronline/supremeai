...
/**
 * Unit tests for StackOverflowExtractor. Tests authority weight, rate limits, and default values.
 */
  ...
  void testExtractErrorSignature_usesTitleByDefault() {
    ActiveInternetScraper.ScrapedIssue issue =
        new ActiveInternetScraper.ScrapedIssue(
            "How to fix NullPointerException?", "Check your objects", "StackOverflow");
