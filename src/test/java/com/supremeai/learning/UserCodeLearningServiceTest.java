...
/**
 * Unit tests for UserCodeLearningService. Tests the diff analysis, category determination, and
 * learning behavior.
 */
...
class UserCodeLearningServiceTest {
  ...
  void learnFromUserEdit_minorChanges_createsMinorCorrection() throws Exception {
    ...
    var analyzeMethod =
        UserCodeLearningService.class.getDeclaredMethod(
            "analyzeCodeDiff", String.class, String.class);
    analyzeMethod.setAccessible(true);
    @SuppressWarnings("unchecked")
    UserCodeLearningService.CodeDiffAnalysis result =
        (UserCodeLearningService.CodeDiffAnalysis) analyzeMethod.invoke(service, original, edited);
    ...
    var catMethod =
        UserCodeLearningService.class.getDeclaredMethod(
            "determineCategory", String.class, UserCodeLearningService.CodeDiffAnalysis.class);
