...
class AIBehaviorProfileRepositoryTest {AIBehaviorProfileRepositorypublic AIBehaviorProfileRepositoryTest(AIBehaviorProfileRepository repository) {
AIBehaviorProfileRepository    this.repository = repository;
AIBehaviorProfileRepository}
    ...
    void findByProjectId_shouldReturnProfilesForProject() {
        AIBehaviorProfile p1 = new AIBehaviorProfile("abp-1", "proj-1", "1.0",
                AIBehaviorProfile.SecurityStrictness.HIGH,
                AIBehaviorProfile.PerformanceTradeoff.BALANCED, null);
        AIBehaviorProfile p2 = new AIBehaviorProfile("abp-2", "proj-1", "1.1",
                AIBehaviorProfile.SecurityStrictness.MEDIUM,
                AIBehaviorProfile.PerformanceTradeoff.SPEED_OPTIMIZED, null);
    ...
    void findByProjectId_shouldReturnEmpty_whenNotFound() {
        ...
        StepVerifier.create(repository.findByProjectId("no-project"))
                .verifyComplete();
    }

    @Test
    void findFirstByProjectId_shouldReturnFirstProfile() {
        AIBehaviorProfile profile = new AIBehaviorProfile("abp-3", "proj-2", "2.0",
                AIBehaviorProfile.SecurityStrictness.LOW,
                AIBehaviorProfile.PerformanceTradeoff.QUALITY_OPTIMIZED, null);
    ...
    void findFirstByProjectId_shouldReturnEmpty_whenNotFound() {
        ...
        StepVerifier.create(repository.findFirstByProjectId("missing"))
                .verifyComplete();
    }

    @Test
    void save_shouldPersistProfile() {
        AIBehaviorProfile profile = new AIBehaviorProfile("abp-new", "proj-new", "1.0",
                AIBehaviorProfile.SecurityStrictness.HIGH,
                AIBehaviorProfile.PerformanceTradeoff.BALANCED, null);
