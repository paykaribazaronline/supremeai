...
class ProjectRepositoryTest {
  ...
  void findByOwnerId_shouldReturnEmpty_whenNoProjects() {
    ...
    StepVerifier.create(projectRepository.findByOwnerId("no-projects")).verifyComplete();
  }
  ...
  void findByStatus_shouldReturnEmpty_whenNoMatchingStatus() {
    ...
    StepVerifier.create(projectRepository.findByStatus("ARCHIVED")).verifyComplete();
  }
  ...
  void deleteById_shouldRemoveProject() {
    ...
    StepVerifier.create(projectRepository.deleteById("proj-delete")).verifyComplete();
  }
}
