...
class ChatRuleRepositoryTest {ChatRuleRepositorypublic ChatRuleRepositoryTest(ChatRuleRepository repository) {
ChatRuleRepository    this.repository = repository;
ChatRuleRepository}
