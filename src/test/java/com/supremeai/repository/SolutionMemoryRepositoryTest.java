...
class SolutionMemoryRepositoryTest {SolutionMemoryRepositorypublic SolutionMemoryRepositoryTest(SolutionMemoryRepository repository) {
SolutionMemoryRepository    this.repository = repository;
SolutionMemoryRepository}
    ...
    void findByTriggerError_shouldFilterByErrorSignature() {
        ...
        s2.setId("sm-2");
        SolutionMemory s3 = new SolutionMemory("NPE at line 99", "Objects.requireNonNull", "Groq", 50, 0.95);
        s3.setId("sm-3");
    ...
    void findByTriggerError_shouldReturnEmpty_whenNoMatch() {
        ...
        StepVerifier.create(repository.findByTriggerError("nonexistent error"))
                .verifyComplete();
    }
    ...
    void delete_shouldRemoveSolution() {
        ...
        StepVerifier.create(repository.delete(s))
                .verifyComplete();
    }
}
