...
public class AuthenticationControllerTest {
  ...
  @Mock private com.google.cloud.spring.data.firestore.FirestoreTemplate firestoreTemplate;

  @Mock private com.supremeai.service.AuthenticationService authenticationService;

  @Mock private com.supremeai.service.ConfigService configService;

  @Mock private com.supremeai.security.BruteForceProtectionService bruteForceProtectionService;
  ...
  void testFirebaseLogin_Success_ExistingUser() throws Exception {
    ...
    AuthenticationController.FirebaseLoginRequest loginRequest =
        new AuthenticationController.FirebaseLoginRequest(idToken);
    MockHttpServletRequest httpRequest = new MockHttpServletRequest();

    ApiResponse<Map<String, Object>> response =
        authenticationController.firebaseLogin(loginRequest, httpRequest).block();
