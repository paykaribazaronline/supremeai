...
class GuideControllerTest {
  ...
  @Mock private UserGuideRepository userGuideRepository;
  ...
  void getAllGuides_shouldReturnPublishedGuides() {
    ...
    StepVerifier.create(controller.getAllGuides()).expectNextCount(2).verifyComplete();
  }
  ...
  void getAllGuides_shouldReturnEmpty_whenNonePublished() {
    ...
    StepVerifier.create(controller.getAllGuides()).verifyComplete();
  }
  ...
  void getGuidesByCategory_shouldReturnEmpty_whenNoMatch() {
    when(userGuideRepository.findByCategoryAndIsPublished("nonexistent", true))
        .thenReturn(Flux.empty());

    StepVerifier.create(controller.getGuidesByCategory("nonexistent")).verifyComplete();
  }
  ...
  void getGuidesByTag_shouldReturnEmpty_whenNoMatch() {
    ...
    StepVerifier.create(controller.getGuidesByTag("nonexistent")).verifyComplete();
  }
