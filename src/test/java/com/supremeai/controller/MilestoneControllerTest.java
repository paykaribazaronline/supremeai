...
class MilestoneControllerTest {
  ...
  @InjectMocks private MilestoneController controller;
  ...
  void getAllMilestones_shouldReturnEmpty_whenNone() {
    ...
    StepVerifier.create(controller.getAllMilestones()).verifyComplete();
  }
  ...
  void deleteMilestone_shouldRemoveMilestone() {
    ...
    StepVerifier.create(controller.deleteMilestone("ms-1")).verifyComplete();
