...
class MonitoringControllerTest {
  ...
  @Mock private ProductionHealthMonitor healthMonitor;

  @InjectMocks private MonitoringController monitoringController;
  ...
  void getHealthStatus_ReturnsHealthMap() {
    Map<String, Object> mockHealth =
        Map.of(
            ...
            3600L,
            "metrics",
            Map.of("totalRequests", 100L, "successfulRequests", 95L));
    ...
    StepVerifierUtil.verifyOkResponse(
        result,
        response -> {
