...
class EvolutionControllerTest {
  ...
  @Mock private ModelEvolutionRepository evolutionRepository;

  @InjectMocks private EvolutionController controller;
  ...
  void getAllEvolutionStates_shouldReturnAll() {
    ...
    StepVerifier.create(controller.getAllEvolutionStates()).expectNextCount(2).verifyComplete();
  }
  ...
  void getAllEvolutionStates_shouldReturnEmpty_whenNone() {
    ...
    StepVerifier.create(controller.getAllEvolutionStates()).verifyComplete();
  }
  ...
  void updateEvolution_shouldSetIdAndSave() {
    ...
    ModelEvolution saved =
        new ModelEvolution("evo-1", "Updated Model", 2, 200, List.of("c3"), true);
