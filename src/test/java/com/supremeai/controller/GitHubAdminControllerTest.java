...
class GitHubAdminControllerTest {
  ...
  @Mock private GitHubAutomationService gitHubAutomationService;

  @InjectMocks private GitHubAdminController controller;
  ...
  void triggerWorkflow_Success() {
    ...
    when(gitHubAutomationService.triggerWorkflow(
            "SupremeAI", "repo", "pipeline.yml", "main", "123"))
        .thenReturn(Mono.empty());
