...
class AppGenerationControllerTest {
  ...
  @Mock private AppOrchestrationService appOrchestrationService;

  @Mock private FullStackCodeGenerator fullStackCodeGenerator;

  @Mock private MultiPlatformGenerator multiPlatformGenerator;

  @Mock private GeneratedAppRepository generatedAppRepository;
  ...
  void generateApp_WithAIAndEntities_GeneratesWithEntities() {
    ...
    verify(codeGenerationService, timeout(3000))
        .generateAppWithAI(
            eq("E-Commerce App"),
            eq("An e-commerce platform"),
            anyList(),
            eq("PostgreSQL"),
            eq("JWT"));
  }
