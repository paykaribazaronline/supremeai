...
class ActivitySummaryControllerTest {
  ...
  void getActivitySummary_withNoFilters_shouldReturnRecentAndTotal() {
    ActivityLog log1 =
        new ActivityLog("LOGIN", "user1", "auth", "info", "Login", "success", "127.0.0.1");
    ActivityLog log2 =
        new ActivityLog("LOGOUT", "user1", "auth", "info", "Logout", "success", "127.0.0.1");
  ...
  void getActivitySummary_withSeverityFilter_shouldUseSeverityQuery() {
    ActivityLog log =
        new ActivityLog("ERROR", "user1", "system", "critical", "Error", "failure", "127.0.0.1");
  ...
  void logActivity_shouldSaveAndReturnLog() {
    ActivityLog input =
        new ActivityLog("ACTION", "user1", "test", "info", "Test action", "success", "10.0.0.1");
    ActivityLog saved =
        new ActivityLog("ACTION", "user1", "test", "info", "Test action", "success", "10.0.0.1");
    saved.setId("log-1");
  ...
  void logActivity_shouldPreserveAllFields() {
    ActivityLog input =
        new ActivityLog(
            "DEPLOY", "admin", "deployment", "info", "Deployed v2.0", "success", "192.168.1.1");
