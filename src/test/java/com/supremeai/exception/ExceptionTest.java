...
/**
 * Unit tests for all exception classes in the project.
 * Tests constructors, message handling, and exception chaining.
 */
class ExceptionTest {
    ...
    void testSimulatorQuotaExceededException_WithUsedAndLimit() {
        SimulatorQuotaExceededException ex =
            new SimulatorQuotaExceededException(100, 50);
    ...
    void testSimulatorDeploymentException() {
        SimulatorDeploymentException ex =
            new SimulatorDeploymentException("Deployment failed");
        assertTrue(ex instanceof SimulatorException);
    ...
    void testSimulatorDeploymentException_WithCause() {
        ...
        SimulatorDeploymentException ex =
            new SimulatorDeploymentException("Deployment failed", cause);
        assertEquals(cause, ex.getCause());
    }
