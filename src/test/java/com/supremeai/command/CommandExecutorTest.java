...
class CommandExecutorTest {
  ...
  void testRegisterCommand() {
    Command mockCommand =
        createMockCommand("test-command", CommandCategory.DATA_REFRESH, CommandType.SYNC);
  ...
  void testExecuteCommandSuccessfully() {
    TestCommand mockCommand =
        new TestCommand("test-command", CommandCategory.DATA_REFRESH, CommandType.SYNC);
  ...
  void testExecutePermissionDenied() {
    TestCommand mockCommand =
        new TestCommand("protected-command", CommandCategory.DATA_REFRESH, CommandType.SYNC);
    CommandContext context = createContext("user", new String[] {"USER"});
