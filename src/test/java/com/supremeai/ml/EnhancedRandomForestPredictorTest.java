...
/**
 * Unit tests for EnhancedRandomForestPredictor. Tests random forest training, prediction, feature
 * importance, and retraining logic.
 */
class EnhancedRandomForestPredictorTest {
  ...
  void testPredict_beforeTraining_returnsDefault() {
    ...
    EnhancedRandomForestPredictor.FailurePrediction prediction =
        predictor.predict("test", features);
  ...
  void testPredict_afterSomeTraining_returnsProbability() {
    ...
    EnhancedRandomForestPredictor.FailurePrediction prediction =
        predictor.predict("test", testFeatures);
  ...
  private double[] invokeExtractFeatures(
      Map<EnhancedRandomForestPredictor.FeatureType, Double> featureMap) {
    try {
      var method =
          EnhancedRandomForestPredictor.class.getDeclaredMethod("extractFeatures", Map.class);
  ...
  private double[][] invokeCopyArray(double[][] original) {
    try {
      var method =
          EnhancedRandomForestPredictor.class.getDeclaredMethod("copyArray", double[][].class);
      method.setAccessible(true);
