...
/**
 * Unit tests for AdvancedPredictiveMLService. Tests ARIMA forecasting, quota prediction, and
...
class AdvancedPredictiveMLServiceTest {
  ...
  private List<Double> invokeApplyDifferencing(List<Double> values, int order) {
    try {
      var method =
          AdvancedPredictiveMLService.class.getDeclaredMethod(
              "applyDifferencing", List.class, int.class);
  ...
  private double invokeCalculateVariance(List<Double> values) {
    try {
      var method =
          AdvancedPredictiveMLService.class.getDeclaredMethod("calculateVariance", List.class);
      method.setAccessible(true);
