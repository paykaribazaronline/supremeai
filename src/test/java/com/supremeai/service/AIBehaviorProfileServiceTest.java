  ...
  void setUp() {
    ...
    try {
      java.lang.reflect.Field field =
          AIBehaviorProfileService.class.getDeclaredField("profileRepository");
    ...
    StepVerifier.create(defaultMono)
        .assertNext(
            profile -> {
              ...
              assertEquals(
                  AIBehaviorProfile.SecurityStrictness.MEDIUM, profile.getSecurityStrictness());
              assertEquals(
                  AIBehaviorProfile.PerformanceTradeoff.BALANCED, profile.getPerformanceTradeoff());
            })
        .verifyComplete();
  }
