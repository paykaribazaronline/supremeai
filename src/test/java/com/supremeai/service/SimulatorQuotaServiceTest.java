...
public class SimulatorQuotaServiceTest {
  ...
  void testValidateCanInstall_ThrowsConflict() {
    ...
    UserSimulatorProfile.InstalledApp app =
        new UserSimulatorProfile.InstalledApp("existing-app", "Test App", "1.0", "url");
    profile.addInstalledApp(app);

    assertThrows(
        SimulatorConflictException.class,
  ...
  void testValidateCanLaunchSession_Success() {
    UserSimulatorProfile.InstalledApp app =
        new UserSimulatorProfile.InstalledApp("app-1", "Test App", "1.0", "url");
    profile.addInstalledApp(app);
  ...
  void testValidateCanLaunchSession_ThrowsSessionException() {
    UserSimulatorProfile.InstalledApp app1 =
        new UserSimulatorProfile.InstalledApp("app-1", "App 1", "1.0", "url");
    UserSimulatorProfile.InstalledApp app2 =
        new UserSimulatorProfile.InstalledApp("app-2", "App 2", "1.0", "url");
