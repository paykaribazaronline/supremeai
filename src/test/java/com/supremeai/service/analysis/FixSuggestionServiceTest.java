...
class FixSuggestionServiceTest {
  ...
  void testValidateFixSyntaxValid() {
    AnalysisFix fix =
        AnalysisFix.builder().fixedCode("public void test() { if (x > 0) { return; } }").build();
  ...
  void testValidateFixSyntaxEmpty() {
    AnalysisFix fix = AnalysisFix.builder().fixedCode("").build();
  ...
  void testValidateFixSyntaxNull() {
    AnalysisFix fix = AnalysisFix.builder().fixedCode(null).build();
  ...
  void testValidateFixSyntaxWithStrings() {
    AnalysisFix fix = AnalysisFix.builder().fixedCode("String s = \"hello { world\";").build();
