...
SimulatorDeploymentRepository}
    ...
    void getStatus_WhenRecordExists_ReturnsStatus() {
        SimulatorDeploymentRecord record = new SimulatorDeploymentRecord("app1", "web", "url", "RUNNING");
    ...
    void getStatus_WhenStatusIsInvalid_ReturnsError() {
        SimulatorDeploymentRecord record = new SimulatorDeploymentRecord("app4", "web", "url", "INVALID_STATUS_123");
    ...
    void getAllDeployments_ReturnsFlux() {
        ...
        StepVerifier.create(service.getAllDeployments())
                .expectNext(record)
                .verifyComplete();
    }
    ...
    void isDeploymentHealthy_NullOrEmptyUrl_ReturnsFalse() {
        StepVerifier.create(service.isDeploymentHealthy(null))
                .expectNext(false)
                .verifyComplete();
    }
}