...
class SoloModeE2ETest {
  ...
  void setUp() {
    ...
    try {
      java.lang.reflect.Field providerRepoField =
          SoloModeManagerService.class.getDeclaredField("providerRepository");
      ...
      java.lang.reflect.Field factoryField =
          SoloModeManagerService.class.getDeclaredField("providerFactory");
      factoryField.setAccessible(true);
      factoryField.set(soloModeManager, providerFactory);

      java.lang.reflect.Field webClientField =
          SoloModeManagerService.class.getDeclaredField("webClientBuilder");
      webClientField.setAccessible(true);
      webClientField.set(soloModeManager, webClientBuilder);

      java.lang.reflect.Field firebaseField =
          SoloModeManagerService.class.getDeclaredField("firebaseRealtimeService");
  ...
  void testVisionServiceFallback() {
    Mono<String> result =
        soloModeManager.getVisionFallback("describe this image", new byte[] {1, 2, 3});
