...
class NativeVisionServiceTest {
  ...
  void processImageNative_textExtraction_returnsSuccess() {
    ...
    Mono<NativeVisionService.NativeVisionResult> result =
        nativeVisionService.processImageNative(
            base64Image, NativeVisionService.VisionTaskType.TEXT_EXTRACTION);
  ...
  void processImageNative_objectDetection_returnsDetectedObjects() {
    ...
    Mono<NativeVisionService.NativeVisionResult> result =
        nativeVisionService.processImageNative(
            base64Image, NativeVisionService.VisionTaskType.OBJECT_DETECTION);
  ...
  void processImageNative_imageClassification_returnsCategory() {
    ...
    Mono<NativeVisionService.NativeVisionResult> result =
        nativeVisionService.processImageNative(
            base64Image, NativeVisionService.VisionTaskType.IMAGE_CLASSIFICATION);
  ...
  void processImageNative_tableExtraction_returnsTableData() {
    ...
    Mono<NativeVisionService.NativeVisionResult> result =
        nativeVisionService.processImageNative(
            base64Image, NativeVisionService.VisionTaskType.TABLE_EXTRACTION);
  ...
  void processImageNative_invalidImage_returnsError() {
    ...
    Mono<NativeVisionService.NativeVisionResult> result =
        nativeVisionService.processImageNative(
            invalidImage, NativeVisionService.VisionTaskType.TEXT_EXTRACTION);
  ...
  void processImageNative_nullImage_returnsError() {
    Mono<NativeVisionService.NativeVisionResult> result =
        nativeVisionService.processImageNative(
            null, NativeVisionService.VisionTaskType.TEXT_EXTRACTION);
