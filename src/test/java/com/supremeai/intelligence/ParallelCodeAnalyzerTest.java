...
/**
 * Unit tests for ParallelCodeAnalyzer. Tests parallel code analysis, chunking, and result
 * aggregation.
 */
class ParallelCodeAnalyzerTest {
  ...
  void testAnalyzeMassiveCode_chunkingByClass() throws Exception {
    ...
    String multiClassCode = "public class A {}\n" + "public class B {}\n" + "public class C {}\n";
  ...
  void testChunkCode_function() throws Exception {
    ...
    java.lang.reflect.Method chunkMethod =
        ParallelCodeAnalyzer.class.getDeclaredMethod("chunkCode", String.class);
    chunkMethod.setAccessible(true);

    @SuppressWarnings("unchecked")
    java.util.List<String> chunks =
        (java.util.List<String>)
            chunkMethod.invoke(analyzer, "public class A {} public class B {}");
