...
/**
 * Unit tests for ClarificationOption.
 * Tests option text, hint, and toString format.
 */
class ClarificationOptionTest {
    ...
    void testToString_withSpecialCharacters() {
        ClarificationOption option = new ClarificationOption("JWT (JSON)", "Best for React/Angular apps");
    ...
    @Test
    void testLongText() {
        String longText = "This is a very long option text that should still work correctly without any issues";
