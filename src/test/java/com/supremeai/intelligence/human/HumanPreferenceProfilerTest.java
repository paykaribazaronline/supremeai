...
/**
 * Unit tests for HumanPreferenceProfiler. Tests developer profile learning, language detection, and
...
class HumanPreferenceProfilerTest {
  ...
  void testLearnFromInteraction_longPromptDoesNotIncreaseDirectPreference() {
    ...
    String prompt =
        "This is a very detailed and long prompt that describes exactly what I need, so it shouldn't trigger the short prompt logic";
    String code = "code";
