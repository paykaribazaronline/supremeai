...
/** Unit tests for VotingTopic. Tests topic creation, getters, and data storage. */
class VotingTopicTest {
  ...
  void testGetters() {
    VotingTopic topic =
        new VotingTopic("id-456", "PERFORMANCE", "some code context", "review this");
  ...
  void testConstructor_longStrings() {
    ...
    String longContext =
        "This is a very long code context that contains many characters and details about the proposed change";
    String longQuestion =
        "This is a very long and detailed question that asks about multiple aspects of the code including security, performance, and maintainability concerns";
  ...
  void testDifferentCategories() {
    String[] categories = {
      "ARCHITECTURE", "SECURITY", "MAINTAINABILITY", "PERFORMANCE", "GENERAL_REVIEW"
    };
