...
/**
 * Unit tests for VotingTopicGenerator.
 * Tests topic generation for different change types and default fallback.
 */
class VotingTopicGeneratorTest {
    ...
    void testGenerateTopicForMajorChange_databaseFlywayMigration() {
        ...
        assertNotNull(topic);
        assertTrue(topic.getQuestionToAsk().toLowerCase().contains("flyway") ||
