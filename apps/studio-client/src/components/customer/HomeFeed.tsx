...
const initialWidgets: Widget[] = [
  {
    ...
    title: "AI Assistant",
    content:
      "Chat with your AI assistant to get help with coding, debugging, and more.",
  },
  {
    id: "2",
    title: "Code Snippets",
    content: "Save and reuse your favorite code snippets.",
  },
  {
    id: "3",
    title: "Project Stats",
    content: "View statistics about your current project.",
  },
  {
    id: "4",
    title: "Quick Commands",
    content: "Execute common commands with one click.",
  },
  {
    id: "5",
    title: "Resource Monitor",
    content: "Monitor CPU, memory, and network usage.",
  },
  {
    id: "6",
    title: "Latest News",
    content: "Stay updated with the latest AI and tech news.",
  },
];
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {widgets.map((widget) => (
          ...
          >
            ...
            <p className="text-[var(--foreground)]/70 text-sm flex-1">
              {widget.content}
            </p>
          </div>
        ))}
