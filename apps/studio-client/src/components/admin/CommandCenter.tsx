...
const initialChat = [
  { id: 1, sender: "Admin", text: "Execute deployment check on Node 47." },
  {
    id: 2,
    sender: "Aethel",
    text: "Analyzing Node 47 (Analytics). Status: Nominal. Load: 38%. Connected.",
  },
...
export function CommandCenter() {
  ...
  const handleSendChat = () => {
    ...
    setChatMessages((prev) => [
      ...
      { id: Date.now(), sender: "Admin", text: chatInput },
      {
        id: Date.now() + 1,
        sender: "Aethel",
        text: `Processing command "${chatInput}"... Authorization confirmed.`,
      },
    ]);
    setChatInput("");
  };
  ...
  useEffect(() => {
          ...
          label: (
            <div className="flex flex-col items-center justify-center p-2 text-center h-full w-full">
              ...
              <div className="mt-3 flex flex-col gap-0.5">
                <span className="text-[9px] text-[#00ff66] font-mono">
                  v.9.2
                </span>
    ...
    const initialEdges = [
      ...
      {
        id: "e-kubernetes-security",
        source: "node-kubernetes",
      ...
      {
        id: "e-security-central",
        source: "node-security",
        target: "central-orb",
        animated: true,
        style: { stroke: "#ffbd2e", strokeWidth: 2 },
      },
      {
        id: "e-analytics-central",
        source: "node-analytics",
        target: "central-orb",
        animated: true,
      ...
      {
        id: "e-apigw-rubernetes",
        source: "node-api-gw",
        target: "node-rubernetes",
        animated: true,
        style: { stroke: "#00f3ff", strokeWidth: 1.5 },
      },
      {
        id: "e-rubernetes-central",
        source: "node-rubernetes",
        target: "central-orb",
        animated: true,
        style: { stroke: "#00ff66", strokeWidth: 2 },
      },
      {
        id: "e-instances-central",
    ...
    <div className="flex-grow flex flex-col overflow-hidden bg-[#030611] text-white scanline relative h-screen font-mono p-4">
      ...
      <header className="flex justify-between items-center border-b border-[#00f3ff]/15 pb-2 mb-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-bold tracking-widest text-[#00f3ff] uppercase">
      ...
      <div className="flex-1 flex flex-row gap-4 overflow-hidden mb-4">
        ...
        <div className="flex-1 bg-[#050917]/50 border border-[#00f3ff]/15 rounded-xl relative overflow-hidden flex flex-col">
          ...
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 w-[380px] bg-[#060b1b]/90 border border-[#00f3ff]/25 rounded-lg p-3 shadow-[0_0_20px_rgba(0,243,255,0.15)] backdrop-blur-md z-20 flex flex-col items-center">
            ...
            <div className="flex items-center justify-center h-8 my-1 w-full">
              ...
              <span
                className="waveform-bar pulse-delay-1"
                style={{ height: "14px" }}
              />
              <span
                className="waveform-bar pulse-delay-2"
                style={{ height: "22px" }}
              />
              <span
                className="waveform-bar pulse-delay-3"
                style={{ height: "12px" }}
              />
              <span
                className="waveform-bar pulse-delay-4"
                style={{ height: "26px" }}
              />
              <span
                className="waveform-bar pulse-delay-5"
                style={{ height: "10px" }}
              />
              <span
                className="waveform-bar pulse-delay-1"
        ...
        <div className="w-[300px] flex flex-col bg-[#050917]/60 border border-[#00f3ff]/15 rounded-xl backdrop-blur-md overflow-hidden">
          <div className="border-b border-[#00f3ff]/15 p-3 flex justify-between items-center bg-[#070d22]">
            <span className="text-xs font-black tracking-widest text-[#00f3ff] uppercase">
              AETHEL | AI ASSISTANT
            </span>
          ...
          <div className="flex-1 overflow-y-auto p-3 space-y-3">
            {chatMessages.map((msg) => (
              <div
                key={msg.id}
                className="text-[10px] leading-relaxed border-b border-cyan-900/10 pb-2"
              >
                <span
                  className={`font-bold tracking-wider mr-1 ${
                    msg.sender === "Admin"
                      ? "text-slate-300"
                      : msg.sender === "Aethel"
                        ? "text-[#00f3ff]"
          ...
          <div className="p-3 border-t border-[#00f3ff]/15 bg-[#060b1c]/80 flex gap-2">
            ...
            <button
              ...
              className="bg-[#00f3ff]/20 hover:bg-[#00f3ff]/40 text-[#00f3ff] p-1.5 rounded transition-all"
            >
              <Send size={12} />
            </button>
          </div>
