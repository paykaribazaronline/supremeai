  ...
  return (
    <div className="flex-grow p-6 overflow-y-auto bg-[#030611] text-[var(--foreground)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <Card
          title="QPS"
          banglaHint="প্রতি সেকেন্ডে মোট রিকোয়েস্ট বা কুয়েরির সংখ্যা।"
        >
        ...
        <Card
          title="P50 Latency"
          banglaHint="৫০% রিকোয়েস্টের গড় প্রসেসিং সময় বা লেটেন্সি।"
        >
          <div className="text-2xl font-bold text-[var(--foreground)] font-mono">
            180ms
          </div>
        ...
        <Card
          title="P99 Latency"
          banglaHint="৯৯% রিকোয়েস্টের সর্বোচ্চ প্রসেসিং সময় বা লেটেন্সি।"
        >
          <div className="text-2xl font-bold text-[#00f3ff] font-mono">
            820ms
          </div>
          <div className="text-[10px] text-yellow-400 font-mono">
            Above threshold (800ms)
          </div>
        </Card>
        <Card
          title="Error Rate"
          banglaHint="মোট রিকোয়েস্টের সাপেক্ষে ফেইল হওয়া এরর পার্সেন্টেজ।"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
        <Card
          ...
          banglaHint="ভিন্ন ভিন্ন পার্সেন্টাইলের (P50, P95, P99) লেটেন্সি চার্ট।"
        >
        ...
        <Card
          title="Endpoint Error Breakdown"
          banglaHint="নির্দিষ্ট এপিআই এন্ডপয়েন্ট ভিত্তিক এরর কাউন্ট বিবরণ।"
        >
          <ResponsiveContainer width="100%" height={200}>
      ...
      <Card
        ...
        banglaHint="সাম্প্রতিক ঘটে যাওয়া অ্যালার্ট, ওয়ার্নিং এবং রিস্টোরেশন স্ট্যাটাস।"
      >
        <div className="flex flex-col gap-2">
          {[
            {
              severity: "warning",
              msg: "High P99 latency detected on /api/chat",
              time: "3m ago",
              status: "Investigating",
            },
            {
              severity: "danger",
              msg: "Memory usage exceeded 85% on GCP Cloud Run",
              time: "12m ago",
              status: "Resolved",
            },
            {
              severity: "info",
              msg: "Deployment v2.1.4 completed successfully",
              time: "45m ago",
              status: "Completed",
            },
          ].map((alert, i) => (
            <div
              key={i}
              className="flex items-center gap-4 p-3 rounded-lg border border-[var(--border-color)] bg-[var(--alert-bg)]"
            >
              <AlertTriangle
                size={14}
                className={
