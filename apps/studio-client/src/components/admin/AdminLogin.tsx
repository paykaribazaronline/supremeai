  ...
  return (
    <div className="flex-1 flex items-center justify-center p-6">
      <div className="w-full max-w-md glass-card text-center flex flex-col gap-6 relative overflow-hidden">
        ...
        <div>
          <span className="text-5xl block mb-2 drop-shadow-[0_0_12px_#bc13fe]">
            👑
          </span>
          ...
          <p className="text-slate-400 text-xs mt-1">
            Authorized access only. Authentication protocol required.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3.5">
          ...
          {adminError && (
            <div className="text-[#ff4d4f] text-xs mt-1 font-mono">
              {adminError}
            </div>
          )}
        </div>
