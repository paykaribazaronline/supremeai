              ...
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  <Shield
                    size={14}
                    className={
                      maintenanceMode ? "text-yellow-400" : "text-slate-500"
                    }
                  />
                ...
                >
                  <div
                    className={`w-4 h-4 rounded-full bg-white transition-transform ${maintenanceMode ? "translate-x-5" : "translate-x-0.5"}`}
                  />
                </button>
              </div>
              {maintenanceMode ? (
                <div className="text-[10px] text-yellow-400 font-mono">
                  ⚠️ System is in maintenance mode. Users will see a maintenance
                  page.
                </div>
              ) : (
                <div className="text-[10px] text-slate-500 font-mono">
                  System is operational. Enable to show maintenance page to
                  users.
                </div>
              )}
            </div>
