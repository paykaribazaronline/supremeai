...
const MOCK_COMMITS = [
  {
    hash: "a1b2c3d",
    message: "fix: resolve memory leak in agent loop",
    author: "admin",
    time: "2h ago",
  },
  {
    hash: "e4f5g6h",
    message: "feat: add RAG document chunking strategies",
    author: "dev1",
    time: "5h ago",
  },
  {
    hash: "i7j8k9l",
    message: "chore: update Docker base image",
    author: "ci-bot",
    time: "8h ago",
  },
  {
    hash: "m0n1o2p",
    message: "feat: implement prompt versioning system",
    author: "admin",
    time: "1d ago",
  },
];
              ...
              >
                ...
                <div className="text-[10px] text-slate-500 font-mono flex items-center gap-2">
                  <span className="flex items-center gap-1">
                    <GitBranch size={10} /> {repo.commits} commits
                  </span>
                  <span className="flex items-center gap-1">
        ...
        <Card title={`Commits: ${selectedRepo.name}`} className="lg:col-span-2">
          ...
          <div className="flex justify-between items-center mt-4 pt-3 border-t border-slate-800">
            <span className="text-[10px] text-slate-500 font-mono">
              Showing 4 of {selectedRepo.commits} commits
            </span>
