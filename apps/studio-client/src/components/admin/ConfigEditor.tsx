    ...
    <div className="flex-grow bg-[#030611] p-6 overflow-y-auto font-mono text-xs">
      ...
      <div className="flex flex-col gap-4">
        {Object.keys(envConfig).map((k) => (
          <div
            key={k}
            className="flex flex-col md:flex-row md:items-center gap-2 bg-[#0c0d12] border border-slate-900 p-3 rounded-lg"
          >
            <span className="font-bold text-slate-300 min-w-[200px] select-all">
              {k}
            </span>
            <input
