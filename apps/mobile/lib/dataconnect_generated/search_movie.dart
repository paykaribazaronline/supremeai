...
class SearchMovieVariablesBuilder {
  ...
  Deserializer<SearchMovieData> dataDeserializer =
  ...
  QueryRef<SearchMovieData, SearchMovieVariables> ref() {
    ...
    return _dataConnect.query(
        "SearchMovie", dataDeserializer, varsSerializer, vars);
  }
}
...
class SearchMovieMovies {
  ...
  int get hashCode => Object.hashAll(
      [id.hashCode, title.hashCode, genre.hashCode, imageUrl.hashCode]);
