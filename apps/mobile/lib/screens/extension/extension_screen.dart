...
class ExtensionScreen extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildPastExtensionTile(context, 'Python Scraper Module',
                'Approved & Integrated', Colors.greenAccent),
            _buildPastExtensionTile(context, 'Real-time Metrics Hub',
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 16),
          Text(
            'extension.subtitle'.tr(),
            style: const TextStyle(
                color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold),
          ),
          const SizedBox(height: 8),
          Text(
            'extension.description'.tr(),
            style: const TextStyle(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {},
              child: Text('extension.submit'.tr().toUpperCase(),
  ...
  Widget _buildPastExtensionTile(
