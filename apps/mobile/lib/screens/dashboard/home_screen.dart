  ...
  void _sendMessage() async {
    ...
    if (orchestration.lastResult != null && mounted) {
      setState(() {
        ...
        final answer =
            (result['answer'] ?? result['message'] ?? 'Requirement analyzed.');
        final sources = (result['sources'] as List<dynamic>?)?.cast<String>() ??
            const <String>[];
        ...
        child: NavigationBar(
          ...
          destinations: [
            ...
            NavigationDestination(
                ...
                label: 'Skills'.tr()),
            NavigationDestination(
                icon: const Icon(Icons.hub_outlined, color: Colors.white54),
      ...
      children: [
        ...
        if (orchestration.isLoading)
          const LinearProgressIndicator(
              backgroundColor: Colors.transparent, color: Colors.blueAccent),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
              child: Text(
                  'Guest Mode: Limited quota. Login to increase limits.'.tr(),
                  style: const TextStyle(
                      fontSize: 11,
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text('Describe what you want to build...'.tr(),
              style: const TextStyle(
                  color: Colors.white,
                  fontSize: 18,
                  fontWeight: FontWeight.bold)),
          const SizedBox(height: 8),
          Text('AI will analyze and generate your project automatically.'.tr(),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          IconButton(
              onPressed: () =>
                  context.read<OrchestrationProvider>().clearError(),
