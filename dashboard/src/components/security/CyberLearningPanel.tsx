      ...
      title={
        ...
        >
          <span style={{ color: "#fff" }}>
            <LockOutlined /> Autonomous Cyber Learning
          </span>
          <Space>
    ...
    >
      <Space direction="vertical" style={{ width: "100%" }}>
        <Text style={{ color: "rgba(255,255,255,0.6)" }}>
          নিজে নিজে হ্যাকিং স্কিল শিখে সিস্টেমকে নিরাপদ রাখার মডিউল।
        </Text>
        <Input
      ...
      <Title level={5} style={{ color: "#fff" }}>
        Mastered Skills ({cyberSkills.length})
      </Title>
        ...
        {cyberSkills.map((skill) => (
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <Text strong style={{ color: "#00f3ff" }}>
                {skill.name}
              </Text>
