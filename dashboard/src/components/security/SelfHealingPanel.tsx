    ...
    <Card
      title={
        <span style={{ color: "#fff" }}>
          <BugOutlined /> Self-Healing System Status
        </span>
      }
      bordered={false}
    ...
    >
      <Row gutter={16}>
        <Col span={8}>
          <Statistic
            title={
              <span style={{ color: "rgba(255,255,255,0.45)" }}>স্ট্যাটাস</span>
            }
        ...
        <Col span={8}>
          <Statistic
            title={
              <span style={{ color: "rgba(255,255,255,0.45)" }}>অটো-হিলিং</span>
            }
              ...
              description={
                <div style={{ marginTop: 8 }}>
                  ...
                  <Space style={{ marginTop: 8 }}>
                    <Tag color="green">
                      Action: {fixResult.actionTaken || "Analyzed"}
                    </Tag>
                    <Tag color="blue">
                      Confidence: {fixResult.confidence || "High"}
                    </Tag>
                  </Space>
                </div>
              }
