  ...
  return (
      ...
      title={
        ...
        >
          <span style={{ color: "#fff" }}>
            <AuditOutlined /> System Self-Audit (Red Team)
          </span>
          <Space>
    ...
    >
      <div style={{ textAlign: "center", padding: "20px 0" }}>
        ...
        <p style={{ marginTop: 16, color: "rgba(255,255,255,0.45)" }}>
          সিস্টেম নিজের ওপর একটি নিয়ন্ত্রিত সাইবার অ্যাটাক সিমুলেট করবে
          রেজিলিয়েন্স পরীক্ষার জন্য।
        </p>
      </div>
            ...
            description={
              <div style={{ marginTop: 8 }}>
                <Text strong style={{ color: "#fff" }}>
                  Score: {(auditReport.resilienceScore * 100).toFixed(1)}%
                </Text>
                <br />
                ...
                <div style={{ marginTop: 12 }}>
                  <Tag color="green">
                    Vulnerabilities: {auditReport.vulnerabilitiesFound}
                  </Tag>
                  <Tag color="blue">
                    Audit ID: {auditReport.auditId.substring(0, 8)}
                  </Tag>
                </div>
              </div>
            }
      ...
      <div style={{ marginTop: 24 }}>
        <Title level={5} style={{ color: "#fff" }}>
          Active Dynamic Protections
        </Title>
        {protections.length === 0 ? (
          <Text type="secondary">No active shields generated yet.</Text>
        ) : (
