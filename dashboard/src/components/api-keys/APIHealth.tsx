...
const APIHealth: React.FC = () => {
  ...
  const handleRemoveDeadKeys = async (report: APIHealthReport) => {
    ...
    Modal.confirm({
      ...
      content:
        "এটি স্থায়ীভাবে সকল ইনঅ্যাক্টিভ এপিআই কী মুছে ফেলবে যা এই রিপোর্টে চিহ্নিত করা হয়েছে।",
      okText: "হ্যাঁ, মুছুন",
      okType: "danger",
      cancelText: "না",
      onOk: async () => {
  ...
  return (
    <Card className="premium-card">
      ...
      >
        <div>
          <Title level={4} style={{ margin: 0 }}>
            <SafetyOutlined /> এপিআই হেলথ রিপোর্ট
          </Title>
          <Text type="secondary">
            আপনার এপিআই কী-গুলোর স্বাস্থ্য এবং কার্যকারিতার ইতিহাস।
          </Text>
        </div>
        <Button
          icon={<ReloadOutlined />}
      ...
      <Table
        ...
        locale={{
          emptyText: (
            <Empty description="এখনও কোনো হেলথ রিপোর্ট তৈরি করা হয়নি।" />
          ),
        }}
