    ...
    <Modal
      title={
        <Space>
          ...
          <span>
            {editingKey ? "এপিআই কী এডিট করুন" : "নতুন এপিআই কী যোগ করুন"}
          </span>
        </Space>
      }
      open={visible}
      ...
      >
        ...
        >
          <Title level={5} style={{ marginTop: 0 }}>
            মডেল ডিসকভারি (প্রস্তাবিত)
          </Title>
          <Text
            type="secondary"
            style={{ display: "block", marginBottom: "15px" }}
          >
            সরাসরি HuggingFace বা OpenRouter থেকে মডেল সার্চ করে কনফিগারেশন
            অটো-ফিল করুন।
          </Text>
        ...
        >
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: "একটি লেবেল দিন (যেমন: My OpenAI Key)",
              },
            ]}
          >
          ...
          >
            <Select
              size="large"
              onChange={(val) =>
                form.setFieldValue("baseUrl", getProviderEndpoint(val))
              }
            >
        ...
        <Form.Item
          ...
          label={
            <span>
              <SafetyOutlined /> এপিআই কী (API Key)
            </span>
          }
        ...
        <Form.Item
          ...
          label={
            <span>
              <LinkOutlined /> বেস ইউআরএল (Base URL)
            </span>
          }
          rules={[
            {
              required: true,
              message: "প্রোভাইডার এপিআই এন্ডপয়েন্ট প্রয়োজন",
            },
          ]}
        ...
        >
          <Select
            mode="tags"
            style={{ width: "100%" }}
            placeholder="উদাঃ gpt-4, claude-3-opus"
            size="large"
          />
        </Form.Item>
