    ...
    <>
      <div className="browser-tab-bar">
        ...
        <Button
          type="text"
          icon={<ExpandOutlined />}
          style={{ color: "rgba(255,255,255,0.3)", marginLeft: "auto" }}
        />
      </div>
      ...
      <div className="browser-toolbar">
        ...
        <Space style={{ marginLeft: 16 }}>
          <Button
            ...
            icon={<LeftOutlined />}
            style={{ color: "#fff" }}
            onClick={() => handleTypeKey("Alt+ArrowLeft")}
          />
          <Button
            type="text"
            icon={<RightOutlined />}
            style={{ color: "#fff" }}
            onClick={() => handleTypeKey("Alt+ArrowRight")}
          />
          <Button
            type="text"
            icon={<ReloadOutlined />}
        ...
        <div className="browser-address-bar">
          ...
          <Tooltip title="View Source Structure">
            <CodeOutlined
              style={{
                color: showDom ? "#00f2fe" : "rgba(255,255,255,0.3)",
                cursor: "pointer",
                marginLeft: 8,
              }}
              onClick={() => {
        ...
        <Space>
          <Tooltip title="AI Thought Stream">
            <Button
              ...
              icon={<CodeOutlined />}
              style={{
                color: showConsole ? "#00f2fe" : "rgba(255,255,255,0.3)",
              }}
          ...
          <Button
            ...
            icon={<SafetyOutlined />}
            style={{
              color: showSettings ? "#00f2fe" : "rgba(255,255,255,0.3)",
            }}
            onClick={() => setShowSettings(true)}
          >
            <Text style={{ color: "inherit", fontSize: 11, marginLeft: 4 }}>
              Safety & Auth
            </Text>
          </Button>
          <Button
