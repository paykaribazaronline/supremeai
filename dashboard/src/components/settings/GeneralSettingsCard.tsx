    ...
    >
      <Form form={form} layout="vertical" onFinish={onFinish}>
        ...
        >
          ...
          <Form.Item
            name="autonomousLearningEnabled"
          ...
          <Form.Item
            name="autonomousAuditEnabled"
            label="Self-Audit Mode"
            valuePropName="checked"
            style={{ marginBottom: 0 }}
          >
            <Switch />
