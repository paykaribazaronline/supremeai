...
const QuotaSettingsCard: React.FC<QuotaSettingsCardProps> = ({
  config,
  onUpdateValue,
}) => {
    ...
    },
    {
      ...
      render: (quota: number, record: any) => (
        <Input
          ...
          defaultValue={quota}
          onBlur={(e) =>
            onUpdateValue("tierQuotas", record.tier, Number(e.target.value))
          }
    ...
    },
    {
      ...
      render: (maxApis: number, record: any) => (
        <Input
          ...
          onBlur={(e) =>
            onUpdateValue("tierMaxApis", record.tier, Number(e.target.value))
          }
  ...
  return (
    ...
    >
      <p style={{ opacity: 0.7, marginBottom: 20 }}>
        Manage operational limits for each user tier. Changes are applied
