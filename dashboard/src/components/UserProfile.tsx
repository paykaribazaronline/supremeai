  ...
  if (!isAuthenticated) {
    return (
      ...
      >
        ...
        />
        <Title level={4} style={{ color: "var(--text-main)", marginBottom: 8 }}>
          গেস্ট এনটিটি
        </Title>
        <Text style={{ color: "var(--text-dim)" }}>
          সিস্টেমের পূর্ণ সুবিধা পেতে লগইন করুন।
        </Text>
      </motion.div>
    );
  }
      ...
      <Space align="start" size="large" style={{ width: "100%" }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          >
            <Title
              level={3}
              style={{ color: "var(--text-main)", margin: 0, fontSize: 20 }}
            >
              {user?.displayName || "অজ্ঞাত ব্যবহারকারী"}
            </Title>
            <Tag
              color={isAdmin ? "success" : "blue"}
      ...
      <div style={{ marginTop: 32 }}>
        ...
        >
          <Text style={{ color: "var(--text-dim)", fontSize: 12 }}>
            ব্যক্তিগত কোটা ব্যবহার
          </Text>
          <Text style={{ color: tierColor, fontSize: 12, fontWeight: "bold" }}>
            78%
          </Text>
        </div>
        <Progress
