        ...
        {loading ? (
          <div style={{ padding: "20px" }}>
            ...
            <div style={{ textAlign: "center", marginTop: "20px" }}>
              <Paragraph strong>
                Analyzing project requirements and orchestrating infrastructure
                blueprint...
              </Paragraph>
            </div>
          </div>
          ...
          <div className="advice-content">
            ...
            <Title level={5}>
              <ToolOutlined /> Next Steps
            </Title>
            <Space direction="vertical">
              <Text>
                <SafetyCertificateOutlined style={{ color: "#52c41a" }} /> Setup
                Google Cloud Project or Firebase Console
              </Text>
              <Text>
                <SafetyCertificateOutlined style={{ color: "#52c41a" }} />{" "}
                Configure environment variables in SupremeAI Dashboard
              </Text>
              <Text>
                <SafetyCertificateOutlined style={{ color: "#52c41a" }} />{" "}
                Initialize automated CI/CD pipeline
              </Text>
            </Space>
          </div>
        ) : (
