        ...
        <Row justify="space-between" align="bottom">
          <Col>
            ...
            <Text style={{ color: "var(--text-dim)", fontSize: 14 }}>
              Real-time cluster telemetry, provider optimization rankings, and
          ...
          <Col>
            <Space>
              <Select
                ...
                style={{ width: 120 }}
                dropdownStyle={{ background: "#080810" }}
              >
            ...
            <Table
              ...
              columns={[
                ...
                },
                {
                  title: "HEALTH",
                  key: "h",
                  render: () => <Badge status="success" text="STABLE" />,
                },
              ]}
        ...
        <Col xs={24} lg={8}>
          <Space direction="vertical" size={24} style={{ width: "100%" }}>
            ...
            >
              ...
              <Text style={{ color: "var(--text-dim)", fontSize: 12 }}>
                Current processing rate: 4.2k ops/sec. Optimized for peak
                traffic.
              </Text>
            </div>
          </Space>
