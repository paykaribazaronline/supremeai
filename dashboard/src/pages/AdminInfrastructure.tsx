  ...
  const fetchAdvice = async () => {
    ...
    try {
      const response = await authUtils.fetchWithAuth(
        "/api/admin/infrastructure/advice",
      );
      if (response.ok) {
        ...
        <Row justify="space-between" align="bottom">
          <Col>
            ...
            <Text style={{ color: "var(--text-dim)", fontSize: 14 }}>
              AI-powered node optimization, cost reduction strategies, and
              distributed cluster integrity.
            </Text>
          </Col>
          <Col>
            <Button
      ...
      <Row gutter={[24, 24]}>
        ...
        <Col xs={24} lg={16}>
          <div className="glass-card" style={{ minHeight: 600 }}>
            <div className="glass-card-title">
              Optimization Roadmap <BulbOutlined style={{ color: "#f59e0b" }} />
            </div>

            {loading ? (
              <div style={{ padding: 100, textAlign: "center" }}>
                <Spin size="large" tip="ANALYZING CLUSTER TOPOLOGY..." />
              </div>
            ) : advices.length > 0 ? (
              <List
                dataSource={advices}
                    ...
                    <div style={{ display: "flex", gap: 16 }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        >
                          ...
                          <Tag color={item.impact === "HIGH" ? "red" : "blue"}>
                            {item.impact} IMPACT
                          </Tag>
                        </div>
                        <Paragraph
        ...
        <Col xs={24} lg={8}>
          <Space direction="vertical" size={24} style={{ width: "100%" }}>
            ...
            >
              <div className="glass-card-title">
                Integrity Guard <SafetyOutlined />
              </div>
            ...
            >
              <div className="glass-card-title">
                Neural Thresholds <ThunderboltOutlined />
              </div>
              <Text style={{ color: "var(--text-dim)", fontSize: 12 }}>
                Cluster scaling policies are currently optimized for
                cost-efficiency. Peak load expected in 4h.
              </Text>
              <Button
                block
