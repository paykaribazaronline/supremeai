...
const AdminReports: React.FC = () => {
  ...
  const [selectedReport, setSelectedReport] = useState<ApiHealthReport | null>(
    null,
  );
  ...
  const healthScore =
    selectedReport && selectedReport.totalKeysTested > 0
      ? Math.round(
          ((selectedReport.activeKeys ?? 0) / selectedReport.totalKeysTested) *
            100,
        )
      : 0;
  ...
  const tabItems = [
      ...
      children: (
        <Row gutter={[24, 24]}>
          <Col xs={24} lg={16}>
            <div className="glass-card" style={{ minHeight: 500 }}>
              <div className="glass-card-title">
                Historical Health Matrix <FileTextOutlined />
              </div>
              <Table
                ...
                columns={[
                  ...
                  },
                  {
                    ...
                    render: (v: number) => (
                      <Badge
                        status="error"
                        text={<span style={{ color: "#ff4d4f" }}>{v}</span>}
                      />
                    ),
                  },
                  {
          ...
          <Col xs={24} lg={8}>
            ...
            >
              <div className="glass-card-title">
                Report Synthesis <AuditOutlined />
              </div>
              {selectedReport ? (
                <Space direction="vertical" size={24} style={{ width: "100%" }}>
                  ...
                  >
                    <Text
                      strong
                      style={{ color: "var(--neon-blue)", fontSize: 12 }}
                    >
                      ...
                      <Badge
                        ...
                        text={
                          <Text style={{ color: "#fff", fontSize: 12 }}>
                            Rotation Queue: {selectedReport.rotationDueKeys}
                          </Text>
                        }
                      />
                    </div>
    ...
    },
    {
      ...
      children: (
        ...
        >
          <Empty description="System activity reporting initialized..." />
        </div>
      ),
    },
    {
      ...
      label: (
        <span className="tab-label">
          <FileTextOutlined /> TEST COVERAGE
        </span>
      ),
      children: (
        <Row gutter={[24, 24]}>
          <Col span={24}>
            ...
            >
              <div className="glass-card-title">
                Code Verification Coverage <CheckCircleOutlined />
              </div>
              <Row gutter={[24, 24]}>
                <Col xs={24} md={8}>
                  <div
                  ...
                  >
                    <div>
                      ...
                      >
                        ...
                        <Text
                          style={{ color: "var(--neon-blue)", fontWeight: 700 }}
                        >
                          88%
                        </Text>
                      </div>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <Text style={{ color: "#faad14", fontWeight: 700 }}>
                          75%
                        </Text>
                      </div>
                      <Progress
        ...
        <Row justify="space-between" align="bottom">
          <Col>
            ...
            <Text style={{ color: "var(--text-dim)", fontSize: 14 }}>
              Aggregated system health analytics, neural consensus logs, and
              operator audits.
            </Text>
          </Col>
          <Col>
