        ...
        <Row justify="space-between" align="bottom">
          <Col>
            ...
            <Text style={{ color: "var(--text-dim)", fontSize: 14 }}>
              Global alert stream, autonomous security pings, and operator
              consensus logs.
            </Text>
          </Col>
          <Col>
            <Space>
              <Button icon={<EyeOutlined />} className="glass-action-button">
                Mark All Read
              </Button>
              <Button
            ...
            <div style={{ marginTop: 24 }}>
              {loading ? (
                <div style={{ textAlign: "center", padding: 100 }}>
                  <Spin size="large" tip="SYNCING NEURAL DISPATCH..." />
                </div>
              ) : notifications.length === 0 ? (
                <Empty description="Dispatcher queue clear." />
              ) : (
                    ...
                    {notifications.map((n) => (
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <div
                              style={{ color: getSeverityColor(n.severity) }}
                            >
                              {n.severity === "critical" ? (
                                <WarningOutlined />
                              ) : (
