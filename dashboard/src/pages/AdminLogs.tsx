      ...
      >
        <Row justify="space-between" align="bottom">
          <Col>
            ...
            >
              <HistoryOutlined
                style={{ color: "rgba(255,255,255,0.45)", fontSize: 20 }}
              />
              <Text
                style={{
            ...
            <Text style={{ color: "var(--text-dim)", fontSize: 14 }}>
              Immutable record of system operations, operator actions, and
            ...
            <Table
              ...
              columns={[
                ...
                },
                {
                  ...
                  key: "action",
                  render: (a: string) => (
                    <Text style={{ color: "var(--neon-blue)" }}>{a}</Text>
                  ),
                },
                {
                  title: "SEVERITY",
                  ...
                  render: (s: string) => (
                    <Tag
                      color={
                        s === "ERROR" ? "red" : s === "WARN" ? "orange" : "blue"
                      }
                    >
                      {s}
                    </Tag>
