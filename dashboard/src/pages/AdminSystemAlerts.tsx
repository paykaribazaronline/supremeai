  ...
  const getAlertIcon = (level: string) => {
    return (
      <ExclamationCircleOutlined
        style={{
          color:
            level === "critical" || level === "error" ? "#ff4d4f" : "#faad14",
        }}
      />
    );
  };
          ...
          <Row gutter={[16, 16]} style={{ marginBottom: 24 }}>
            <Col span={6}>
              <Card className="glass-card" style={{ textAlign: "center" }}>
                ...
                <div
                  style={{ color: "#ff4d4f", fontSize: 28, fontWeight: 700 }}
                >
            ...
            <Col span={6}>
              <Card className="glass-card" style={{ textAlign: "center" }}>
                ...
                <div
                  style={{ color: "#ff7f50", fontSize: 28, fontWeight: 700 }}
                >
            ...
            <Col span={6}>
              <Card className="glass-card" style={{ textAlign: "center" }}>
                ...
                <div
                  style={{ color: "#faad14", fontSize: 28, fontWeight: 700 }}
                >
            ...
            <Col span={6}>
              <Card className="glass-card" style={{ textAlign: "center" }}>
                ...
                <div
                  style={{ color: "#1890ff", fontSize: 28, fontWeight: 700 }}
                >
