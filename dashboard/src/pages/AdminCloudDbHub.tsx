...
export default function AdminCloudDbHub() {
  ...
  const fetchDocuments = async () => {
    ...
    try {
      const res = await authUtils.fetchWithAuth(
        `/api/admin/firestore/${selectedCollection}`,
      );
      if (res.ok) {
  ...
  const handleSaveDoc = async () => {
    ...
    try {
      ...
      const res = await authUtils.fetchWithAuth(
        `/api/admin/firestore/${selectedCollection}/${editingDoc._id}`,
        {
          method: "PUT",
    ...
    Modal.confirm({
      title: (
        <Text style={{ color: "#fff", fontWeight: 700 }}>
          ডকুমেন্ট মুছে ফেলার নিশ্চয়তা
        </Text>
      ),
      content: (
        <Text style={{ color: "rgba(255,255,255,0.7)" }}>
          আপনি কি নিশ্চিতভাবে এই ডকুমেন্টটি চিরতরে মুছে ফেলতে চান? এটি আর
      ...
      centered: true,
      okButtonProps: {
        style: { background: "var(--neon-pink)", border: "none" },
      },
      onOk: async () => {
        try {
          const res = await authUtils.fetchWithAuth(
            `/api/admin/firestore/${selectedCollection}/${id}`,
            {
              method: "DELETE",
            },
          );
  ...
  const runGitSync = () => {
    ...
    setTimeout(() => {
      setGitSyncing(false);
      message.success(
        "Git repositories fully synchronized with GitHub & GitLab!",
      );
    }, 1500);
  };
    ...
    >
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        <Text style={{ color: "var(--neon-blue)", fontSize: 13 }}>
          ফায়ারবেস ডাটাবেস, গুগল ক্লাউড এবং গিট কমান্ড সেন্টারের লাইভ ওয়ান-স্টপ
          মিনি কন্ট্রোল হাব
        </Text>
      </div>
      ...
      >
        ...
        <Tabs.TabPane
          tab={
            <span>
              <DatabaseOutlined /> 🛢️ Firebase Console
            </span>
          }
          key="1"
        >
                    ...
                    },
                    {
                      ...
                      render: (_, record) => (
                        <Space>
                          ...
                          <Button
                            icon={<DeleteOutlined />}
                            onClick={() => handleDeleteDoc(record._id)}
                            danger
                            size="small"
                          />
                        </Space>
        ...
        <Tabs.TabPane
          tab={
            <span>
              <CloudServerOutlined /> ☁️ Google Cloud HUD
            </span>
          }
          key="2"
        >
            ...
            <Col xs={24} lg={16}>
              ...
              >
                ...
                >
                  ...
                  <div
                    style={{
                      background: "rgba(240, 46, 170, 0.05)",
                      border: "1px solid rgba(240, 46, 170, 0.1)",
                      padding: "16px 24px",
                      borderRadius: 8,
                      flex: 1,
                      minWidth: 200,
                ...
                <div style={{ marginBottom: 12 }}>
                  ...
                  >
                    <CodeOutlined /> CLOUD DIAGNOSTIC CONSOLE
                  </Text>
                  <div
                    style={{
                      background: "#04040a",
        ...
        <Tabs.TabPane
          tab={
            <span>
              <GitlabOutlined /> 🐙 Git Command Center
            </span>
          }
          key="3"
        >
              ...
              <Card className="glass-card" style={{ padding: 8 }}>
                ...
                >
                  <div>
                    ...
                    <Text style={{ color: "rgba(255,255,255,0.5)" }}>
                      GitHub/GitLab অটো-সিনক্রোনাইজেশন কমান্ড মডিউল
                    </Text>
                  </div>
                  <Button
                    type="primary"
                ...
                <div>
                  <Title level={5} style={{ color: "#fff", marginBottom: 12 }}>
                    <InfoCircleOutlined /> রিসেন্ট রিমিট সিঙ্ক লগ
                  </Title>
                  <div
                    style={{
                      background: "#04040a",
                  ...
                  >
                    ...
                    * Branch 'main' set up to track remote branch 'main' from
                    'gitlab'.
                    <br />* Everything up-to-date (remotes fully synched)
                  </div>
                </div>
              </Card>
            </Col>
      ...
      <Modal
        title={
          <Text style={{ color: "#fff", fontWeight: 700 }}>
            🛢️ Edit Firestore Document JSON
          </Text>
        }
