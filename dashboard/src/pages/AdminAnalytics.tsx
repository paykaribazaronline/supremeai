  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (rankingsRes.ok) {
        ...
        const formatted = Object.entries(list)
        ...
        <Row justify="space-between" align="bottom">
          <Col>
            ...
            <Text style={{ color: "var(--text-dim)", fontSize: 14 }}>
              Global performance tracking, provider rankings, and success
              distribution.
            </Text>
          </Col>
          <Col>
                ...
                >
                  <div>
                    ...
                    <div
                      style={{ color: "#fff", fontSize: 24, fontWeight: 800 }}
                    >
                      {stats?.systemHealthScore || 100}/100
                    </div>
                  </div>
                  <SafetyCertificateOutlined
            ...
            <Table
              ...
              columns={[
                ...
                },
                {
                  ...
                  render: (s: number) => (
                    <Progress
                      ...
                      size="small"
                      strokeColor={
                        s > 90 ? "var(--success)" : "var(--neon-blue)"
                      }
                    />
                  ),
                },
                ...
                },
                {
                  ...
                  render: (s: string) => (
                    <Badge
                      status={s === "excellent" ? "success" : "processing"}
                      text={
                        <span
                          style={{
                            color: "#fff",
          ...
          <Space direction="vertical" size={24} style={{ width: "100%" }}>
              ...
              <div style={{ padding: "8px 0" }}>
                <div style={{ marginBottom: 20 }}>
                  ...
                  >
                    ...
                    <Text
                      style={{ color: "var(--neon-blue)", fontWeight: 800 }}
                    >
                      94%
                    </Text>
                  </div>
                ...
                <div style={{ marginBottom: 20 }}>
                  ...
                  >
                    ...
                    <Text
                      style={{ color: "var(--neon-purple)", fontWeight: 800 }}
                    >
                      88%
                    </Text>
                  </div>
                ...
                <div>
                  ...
                  >
                    ...
                    <Text style={{ color: "var(--success)", fontWeight: 800 }}>
                      82%
                    </Text>
                  </div>
                  <Progress
            ...
            >
              ...
              <Text style={{ color: "var(--text-dim)", fontSize: 12 }}>
                The system is currently auto-tuning weights based on the last
                50,000 requests. Efficiency gain: +4.2%.
              </Text>
            </div>
          </Space>
        </Col>
