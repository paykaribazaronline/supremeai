  ...
  const handleConfig = async () => {
    try {
      ...
      if (res.ok) {
        ...
        message.info(
          "Config loaded — apply settings in the reverse engineer settings panel",
        );
      } else {
        ...
        <Row justify="space-between" align="bottom">
          <Col>
            ...
            <Text style={{ color: "var(--text-dim)", fontSize: 14 }}>
              Deconstruct, analyze, and automate external digital architectures
              using AI agents.
            </Text>
          </Col>
          <Col>
      ...
      <Row gutter={[24, 24]}>
        ...
        <Col lg={16} md={24}>
          <Space direction="vertical" size={24} style={{ width: "100%" }}>
            <div
              className="glass-card"
              style={{ borderTop: "2px solid var(--neon-blue)" }}
            >
          ...
          <Space direction="vertical" size={24} style={{ width: "100%" }}>
            ...
            >
              ...
              <Text style={{ color: "var(--text-dim)", fontSize: 13 }}>
                System is currently bypassing standard JS obstacles with 94%
                accuracy. Anti-bot resilience: High.
              </Text>
            </div>
          </Space>
        </Col>
