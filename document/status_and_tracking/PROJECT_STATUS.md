...
- [ ] **Multi-Cloud Active-Active Deployment**: GCP, Railway, Render-এ একটিভ নোড ডেপ্লয় করা এবং ক্লাউডফ্লেয়ার লোড ব্যালেন্সার স্ক্রিপ্ট ও শেয়ার্ড ডাটাবেস (Supabase, Upstash) যুক্ত করা।
