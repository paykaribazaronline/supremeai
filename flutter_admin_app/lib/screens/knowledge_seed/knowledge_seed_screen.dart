  ...
  Future<void> _submitSeed() async {
    ...
    try {
      ...
      final seed = ExternalKnowledgeSeed(
        ...
        seededByUserId: auth.currentUser?['id'] ?? 'anonymous',
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Card(elevation: 2, child: Padding(padding: const EdgeInsets.all(16.0), child: Column(children: [
              TextFormField(
                ...
                validator: (value) => Validators.validateRequired(value, 'AI Model Name'),
              ...
              TextFormField(
                ...
                validator: (value) => Validators.validateRequired(value, 'Prompt'),
                enabled: !_isSubmitting,
              ),
              const SizedBox(height: 16),
              TextFormField(
                ...
                validator: (value) => Validators.validateRequired(value, 'AI Response'),
                enabled: !_isSubmitting,
              ),
              const SizedBox(height: 16),
