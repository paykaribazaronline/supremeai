...
গুগল ক্লাউড বিল্ডের মাধ্যমে লোকাল ডকার ডেমন ব্যবহার না করেই সরাসরি ক্লাউডে ৩টি মূল সার্ভিসের কন্টেইনার ইমেজ বিল্ব ও ক্লাউড রানে ডেপ্লয় করা হয়েছে:
1. **SupremeAI Backend:** কন্টেইনারাইজড করা হয়েছে এবং ২ সিপিইউ ও ২জিবি মেমরির মিনিমাম ১টি রানিং ইনস্ট্যান্স সহ us-central1 জোনে সফলভাবে রান করা হয়েছে।
2. **Reverse Engineering Microservice:** ক্লাউড রানে সফলভাবে রিলিজ হয়েছে।
3. **Simulator Runtime Microservice:** সফলভাবে ক্লাউড রানে ডেপ্লয় হয়েছে।
