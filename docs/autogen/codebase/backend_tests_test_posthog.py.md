# 📄 ফাইল: backend/tests/test_posthog.py

**প্রকার:** .py  
**সাইজ:** 553 বাইট  
**আপডেট:** 2026-07-10T19:10:52.082794
...
def test_posthog_client_capture_mock(mock_logger):
    ...
    posthog_client.capture(distinct_id="test-user-123", event="test_event", properties={"foo": "bar"})
