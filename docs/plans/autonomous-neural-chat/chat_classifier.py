...
class ChatClassifier:
    def __init__(self):
        # রুলস ডিটেক্ট করার জন্য প্যাটার্ণ
        self.rule_patterns = [
        ...
        # প্ল্যান ডিটেক্ট করার জন্য প্যাটার্ণ
        self.plan_patterns = [
        ...
        # কমান্ড ডিটেক্ট করার জন্য প্যাটার্ণ
    ...
    def _calculate_score(self, message: str, patterns: List[str], chat_type: ChatType) -> float:
        """
        একটি চ্যাট মেসেজের জন্য নির্দিষ্ট প্যাটার্ণ সেটের স্কোর ক্যালকুলেট করে।

        Args:
            message: চ্যাট মেসেজ (ছোট হাতের অক্ষরে)
            patterns: মেসেজ চেক করার জন্য প্যাটার্ণ সেট
