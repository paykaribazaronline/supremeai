...
4. **ডকুমেন্টেশন সিঙ্ক:** কোনো প্ল্যান, টাস্ক বা রুল আপডেট হলে, `document/` ফোল্ডারের প্রতিটি ফাইল (PROJECT_STATUS.md, 100%_completed_tasks.md, partially_completed_tasks.md, ইত্যাদি) একসাথে আপডেট করতে হবে।
5. **স্থায়ী অ্যাডমিন ইনবক্স:** `document/admin's_plan` ডিরেক্টরিটি নতুন প্ল্যানের জন্য অ্যাডমিনের স্থায়ী ইনবক্স। এই ফোল্ডারটি কখনো ডিলিট করা যাবে না, তবে ফাইল প্রসেস হয়ে গেলে এর ভেতরের ফাইলগুলো মুছে ফেলতে হবে।
