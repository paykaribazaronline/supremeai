...
class ModelVersionManager:
    ...
    def _sync_to_supabase(self, version: ModelVersion):
        ...
        try:
            ...
            logger.info(
                f"Synced version {version.version_id} to Supabase ModelVersion table."
            )
    ...
    def _sync_to_hf_hub(self, version: ModelVersion, repo_id: str | None = None):
        ...
        try:
            ...
            logger.info(
                f"Uploaded model version {version.version_id} metadata to HF Hub repo {repo_id}."
            )
        except Exception as e:
    ...
    def rollback(
        self, model_name: str, reason: RollbackReason, details: str | None = None
    ) -> str | None:
