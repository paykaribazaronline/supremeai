...
for line in lines:
    ...
    if line.startswith("## Category "):
        ...
        if "id" in repo_data and "url" in repo_data:
            ...
            sql.append(
                f"INSERT INTO github_repos (id, name, url, category, purpose, priority, stars) VALUES ('{id_val}', '{name_val}', '{url_val}', '{cat_val}', '{pur_val}', '{pri_val}', {stars_val}) ON CONFLICT (id) DO NOTHING;"
            )
        repo_data = {}
