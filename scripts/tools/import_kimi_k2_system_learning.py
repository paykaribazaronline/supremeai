    ...
    "documents": [
            ...
            "content": {
                "layers": {
                    ...
                    "api_gateway": {
                        ...
                        "endpoint": "https://ide-api.supremeai.google.com/api/",
                    },
                    "data_layer": {
                        "components": [
                            "Firestore Database",
        ...
        },
        {
            ...
            "endpoints": [
                {
                    "name": "API Health",
                    "url": "https://ide-api.supremeai.google.com/api/health",
                    "expected": {"status": "UP"},
                },
                {
                    "name": "Agent Status",
                    "url": "https://ide-api.supremeai.google.com/api/agents/status",
                ...
                {
                    "name": "Metrics",
                    "url": "https://ide-api.supremeai.google.com/api/metrics/health",
...
VERIFIED_RECORD_BLUEPRINTS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "context": {
            ...
            "importSource": VERIFIED_SOURCE,
            "verification": "repo-proven",
            "file": "src/main/java/com/supremeai/Application.java",
        },
    ...
    },
    {
        ...
        "context": {
            ...
            "files": [
                ...
                "src/main/java/com/supremeai/service/FirebaseRealtimeService.java",
    ...
    },
    {
        ...
        "context": {
            ...
            "importSource": VERIFIED_SOURCE,
            "verification": "repo-proven",
            "file": "src/main/java/com/supremeai/service/SystemLearningService.java",
        },
