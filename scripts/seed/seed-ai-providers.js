...
const META = {
  'chickenbrain': { name:'SupremeAI ChickenBrain',        type:'cloud_run',
    ...
    languages:['en','bn','python','javascript','java','go'], priority:1 },
  'superfly':     { name:'SupremeAI SuperFly Edge',       type:'superfly',
    roles:['COMMUNICATION'],
    models:['superfly-94m'],
    capabilities:['chat','fast_response','lightweight_reasoning'],
    languages:['en','bn'], priority:2 },
