...
def build_god_context(
    source_dir="context_modules", output_file="supremeai_god_context.xml"
):
    ...
    print(
        f"✅ সফলভাবে {len(xml_files)}টি মডিউল যুক্ত করে {output_file} তৈরি করা হয়েছে।"
    )
