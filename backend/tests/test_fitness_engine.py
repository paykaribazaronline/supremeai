...
def temp_fitness_env(tmp_path):
    ...
    registry.register_skill(
        ...
        uss={
            "metadata": {"name": "DummySkill", "version": "1.0.0", "description": "test", "author": "test", "tags": []},
            "interface": {"input_schema": {"type": "object"}, "output_schema": {"type": "object"}},
            "execution": {"runtime": "python3.11", "entry_point": "main.execute", "dependencies": [], "timeout_seconds": 30},
