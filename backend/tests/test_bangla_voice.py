...
def test_bangla_voice_init():
    with patch(
        "tools.bangla_voice.BanglaVoice._check_stt_available", return_value=True
...
def test_bangla_voice_transcribe_whisper():
    ...
    with patch("tools.bangla_voice.os.path.exists", return_value=True), patch(
        "tools.bangla_voice.BanglaVoice._check_stt_available", return_value=True
...
def test_bangla_voice_speak_coqui():
    ...
    with patch(
        "tools.bangla_voice.BanglaVoice._check_tts_available", return_value=True
