...
class PlatformRegistry:
    ...
    def get_platform(self, name: str) -> Optional[PlatformProfile]:
    ...
    def _load_preloaded_platforms(self):
        ...
        self.register_platform(PlatformProfile(
            ...
            capabilities=["repo_create", "pages_deploy", "actions_ci", "secret_management"],
        ...
        self.register_platform(PlatformProfile(
            ...
            capabilities=["hosting_deploy", "functions_deploy", "database", "auth", "storage"],
