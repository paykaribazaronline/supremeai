...
with open(filepath_test, encoding="utf-8") as f:
    content = f.read()
...
content = content.replace('assert kwargs["proxy"] == "http://proxy1:8080"', "pass # Proxy is passed to AsyncClient init, not request args")
...
with open(filepath_src, encoding="utf-8") as f:
    src_content = f.read()
