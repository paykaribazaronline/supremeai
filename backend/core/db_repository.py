...
class SmartDataRepository:
    ...
    async def _fetch_from_primary(self, collection: str, doc_id: str) -> Optional[Dict[str, Any]]:
        try:
    ...
    async def get_document_with_fallback(self, table_name: str, doc_id: str) -> Optional[Dict[str, Any]]:
        try:
