...
class PromptFirewall:
                        ...
                        mapped_patterns.append(
                            {
                                ...
                                "patterns": row.get("rule_definition", {}).get(
                                    "patterns", []
                                ),
                            }
                        )
    ...
    def _check_local_patterns(self, prompt: str) -> str | None:
    ...
    async def scan_with_llama_guard(self, prompt: str) -> str | None:
