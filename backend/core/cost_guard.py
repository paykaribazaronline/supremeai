...
class CostGuard:
    def __init__(self, db: Any = None):
        ...
        self.tier_limits = {
            "free": 0.0,
            "economy": float(
                getattr(settings, "cost_tier_economy_limit", 0.02)
            ),  # প্রতি টাস্কে সর্বোচ্চ খরচ ২ সেন্ট
            "premium": float(
                getattr(settings, "cost_tier_premium_limit", 0.50)
            ),  # প্রিমিয়াম মডেলের বাজেট গেট
        }
