...
# Core Routers
core_routers = [
    ("api.routes.memory_router", ""),
    ("api.routes.task_router", ""),
    ("api.routes.markdown_router", "/api/v1"),
    ("api.routes.simulator_router", ""),
    ("api.routes.site_actions_router", ""),
    ("api.routes.llm_gateway_router", ""),
    ("api.routes.browser_router", ""),
    ("api.routes.stream_router", ""),
    ("api.routes.agent_router", ""),
    ("api.routes.async_task_router", ""),
    ("api.routes.cdc_router", ""),
    ("api.routes.media_router", ""),
    ("api.routes.graph_router", ""),
    ("api.routes.knowledge_router", ""),
    ("api.routes.marketplace_router", ""),
    ("api.routes.auth_router", ""),
    ("api.routes.admin_dashboard_router", ""),
    ("api.routes.email_router", ""),
    ("api.routes.github_router", ""),
    ("api.routes.internal_router", ""),
    ("api.routes.config_router", ""),
    ("api.routes.onboarding_router", ""),
    ("api.routes.repos_router", ""),
    ("api.routes.tools_ops_router", ""),
    ("api.routes.agents_router", ""),
    ("api.routes.tools_registry_router", ""),
    ("api.routes.preferences_router", ""),
    ("api.routes.usage_metrics_router", ""),
    ("api.routes.payments_router", ""),
    ("api.routes.sso_router", ""),
    ("api.routes.api_keys_router", ""),
    ("api.routes.ci_webhooks_router", ""),
    ("core.orchestrator", ""),
]
...
optional_routers = [
    ("api.routes.websocket_voice_router", ""),
    ...
    ("api.routes.codeflow_router", ""),
    ("api.routes.feedback_router", ""),
    ("tools.multilingual_tts", "/api"),
    ("api.routes.voice_router", "/api/voice"),
