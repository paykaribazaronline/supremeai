...
class MultiLayerCache:
    ...
    async def get(self, prompt: str, model_name: str, session_id: Optional[str] = None) -> Optional[Dict[str, Any]]:
        """
    ...
    async def set(self, prompt: str, response: str, model_name: str, session_id: Optional[str] = None):
