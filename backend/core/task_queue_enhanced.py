...
class TaskQueue:
    ...
    def _init_backends(self):
        ...
        logger.info(f"TaskQueue initialized with backends: "
    ...
    async def _submit_to_celery(self, func: Callable, task_id: str, 
                               args: tuple, kwargs: dict, priority: TaskPriority):
        ...
        if not hasattr(func, 'delay'):
            ...
            task = celery_wrapper.apply_async(
                args=[task_id, func.__name__, args, kwargs],
    ...
    async def _submit_to_redis(self, func: Callable, task_id: str,
                              args: tuple, kwargs: dict, priority: TaskPriority):
    ...
    async def _submit_to_pubsub(self, func: Callable, task_id: str,
                               args: tuple, kwargs: dict, priority: TaskPriority):
    ...
    async def _submit_to_asyncio(self, func: Callable, task_id: str,
    ...
    async def _execute_sync(self, func: Callable, task_id: str,
                           args: tuple, kwargs: dict):
...
def task(name: str = None, priority: TaskPriority = TaskPriority.NORMAL, 
