...
def _get_supabase_db_url() -> str:
    return getattr(settings, "supabase_database_url", "") or os.getenv("SUPABASE_DATABASE_URL", "")
...
async def supabase_execute_sql(params: ExecuteQueryInput) -> str:
    ...
    """
    admin_authorized = getattr(settings, "admin_authorized", "false").lower() == "true" or os.getenv("ADMIN_AUTHORIZED", "false").lower() == "true"
