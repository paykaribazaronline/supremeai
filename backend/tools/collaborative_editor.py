...
class CollaborativeEditor:
    ...
    async def get_session_state(self, session_id: str) -> dict:
        ...
        if not state:
            return {"document_state": "", "ai_cursor": {"position": 0, "status": "idle"}}
    ...
    async def broadcast_delta(self, session_id: str, delta: dict, sender_id: str = None):
        ...
        await self.update_session_state(session_id, {
            ...
            "ai_cursor": json.dumps(ai_cursor)
        })
    ...
    async def _process_ai_request(self, session_id: str, prompt: str):
        ...
        try:
            ...
            await self.broadcast(session_id, {"type": "ai_response", "status": "idle"}, sender_id="supreme-ai-agent")
