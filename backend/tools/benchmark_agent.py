...
class BenchmarkAgent:
    ...
    BENCHMARK_PROMPTS = [
        {"category": "coding", "prompt": "Write a Python function to calculate the factorial of a number using recursion."},
        {"category": "reasoning", "prompt": "If all Zirps are Zorps, and some Zorps are Zots, can we say for certain that some Zirps are Zots? Explain your reasoning."},
        {"category": "creative", "prompt": "Write a short, three-line poem about a robot learning to dream."},
