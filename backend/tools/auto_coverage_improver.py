...
async def main():
    ...
    # If the auditor failed to initialize, exit gracefully
    if improver.auditor is None:
        logger.error("AutoCoverageImprover cannot proceed as its core auditing component is unavailable.")
        sys.exit(1)
