...
- **Post-Fix DB Injection:** যেকোনো বাগ ফিক্স, সিআই সমাধান বা রিফ্যাক্টরিং টেস্ট পাসের পর—তার Error Pattern, Root Cause ও Fix Snippet সরাসরি `CascadeMemoryService` (`ai_memory` pgvector) এবং `LESSONS_LEARNED.md`-তে ইনজেক্ট করুন যাতে ভবিষ্যতে একই সমস্যা সিস্টেম নিজে সেলফ-হিল করে।
